...
}(V), k = /^[_a-zA-Z][_a-zA-Z0-9]*$/, S = /** @class */ function(t) {
    function n() {
        return null !== t && t.apply(this, arguments) || this;
    }
    return e.__extends(n, t), n.prototype.V = function(t, e, r) {
 ...
 */ var ct = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.$t = it(), this.Nt = new Y(this.P)
        /**
...
/** Returns a reference value for the provided database and key. */ function Rt(t, e) {
    return {
...
function $t(t, e) {
    ...
    new R((d((n = r).length > 4 && "documents" === n.get(4)), n.p(5)));
}
...
var Be = function(t, e) {
    ...
    return t.on = function(e) {
        ...
        get: function() {
            if (null === this.nn) {
                ...
                t.L() || this.nn.push(new cn(t)), this.nn.push(new cn(S.M(), "asc" /* ASCENDING */)); else {
    ...
    t.prototype.Pn = function() {
        if (!this.sn) if ("F" /* First */ === this.en) this.sn = C(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            for (
            ...
            // Now return as a LimitType.First query.
                        this.sn = C(this.path, this.collectionGroup, t, this.filters, this.limit, o, s);
        }
        return this.sn;
...
/** Returns whether `doc` matches the constraints of `query`. */ function Je(t, e) {
    return function(t, e) {
        var n = e.key.path;
        return null !== t.collectionGroup ? e.key.U(t.collectionGroup) && t.path.C(n) : R.W(t.path) ? t.path.isEqual(n) : t.path.D(n);
    }(t, e) && function(t, e) {
 ...
 */ function an(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.L() ? R.P(R.B(s.referenceValue), n.key) : Lt(s, n.field(o.field)), 
...
function fn(t, e, n) {
    var r = t.field.L() ? R.P(e.key, n.key) : function(t, e, n) {
 ...
 */ var pn = /** @class */ function() {
    ...
    t.prototype.Zn = function(t, e, n) {
        ...
        return this.jn(t, new R(e)).next((function(t) {
            var e = it();
        ...
        return this.persistence.runTransaction("Locally write mutations", "readwrite", (function(o) {
            return n.Di.Yn(o, i).next((function(i) {
                ...
                var s = [], u = 0, a = t; u < a.length; u++) {
                    ...
                    // exists=true
                    s.push(new Se(h.key, c, Ge(c.proto.mapValue), Ne.exists(!0)));
                }
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 5:
                    return this.Vi = this.Vi.remove(t), this.yi.delete(r.target), [ 2 /*return*/ ];
                }
            }));
        }));
...
var kn = /** @class */ function() {
    ...
    t.prototype.Nr = function(t) {
        var e = this, n = new R(new U([])), r = new Sn(n, t), i = new Sn(n, t + 1), o = [];
        ...
        var e = new R(new U([])), n = new Sn(e, t), r = new Sn(e, t + 1), i = ut();
        return this.Sr.bt([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.Or = function(t) {
        var e = new Sn(t, 0), n = this.vr.Ct(e);
    ...
    return t.br = function(t, e) {
        return R.P(t.key, e.key) || m(t.Lr, e.Lr);
    }, 
    /** Compare by ID then by key */ t.Cr = function(t, e) {
        return m(t.Lr, e.Lr) || R.P(t.key, e.key);
    }, t;
}();
 ...
 */ var er = /** @class */ function() {
    ...
    return t.fromBase64String = function(e) {
        On("Blob.fromBase64String", arguments, 1), Cn("Blob.fromBase64String", "string", 1, e), 
        tr();
        try {
        ...
        if (On("Blob.fromUint8Array", arguments, 1), Kn(), !(e instanceof Uint8Array)) throw Yn("Blob.fromUint8Array", "Uint8Array", 1, e);
    ...
    for (var e = 0; e < t.length; ++e) if (Cn("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new D(T.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
    this.qr = new S(t);
}, rr = /** @class */ function(t) {
    /**
    ...
    return e.__extends(n, t), n.documentId = function() {
        ...
        if (!(t instanceof n)) throw Yn("isEqual", "FieldPath", 1, t);
...
var ar = /** @class */ function(t) {
    ...
    return e.__extends(n, t), n.delete = function() {
        return Rn("FieldValue.delete", arguments), new pr(new sr("FieldValue.delete"));
    }, n.serverTimestamp = function() {
        return Rn("FieldValue.serverTimestamp", arguments), new pr(new ar("FieldValue.serverTimestamp"));
        ...
        return Cn("FieldValue.increment", "number", 1, t), On("FieldValue.increment", arguments, 1), 
    ...
    function t(t, e) {
        if (On("GeoPoint", arguments, 2), Cn("GeoPoint", "number", 1, t), Cn("GeoPoint", "number", 2, e), 
...
/** A "context" object passed around while parsing user data. */ var br = /** @class */ function() {
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.so = function(e) {
        ...
        return Sr(t, this.settings.methodName, this.settings.ao || !1, this.path, this.settings.Gr);
    }, 
...
/** Parse update data from a list of field/value arguments. */ function Ar(t, e, n, r, i, o) {
    ...
    for (var c = [], f = new Fe, l = u.length - 1; l >= 0; --l) if (!Rr(c, u[l])) {
 ...
 */ function Dr(t, e) {
    ...
    return function(t, e) {
        ...
        if (t instanceof gr) {
            ...
            return {
                referenceValue: Xt(t.Jr || e.s, t.Zr.path)
            };
        }
 ...
 */ function kr(t, n, r) {
    try {
        ...
        throw Sr((i = n) instanceof Error ? i.message : i.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
    /**
...
var Mr = function(t, e) {
    ...
    return e.__extends(n, t), n.prototype.jo = function(t) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var h = $t(t, a.document.name), c = Yt(a.document.updateTime), f = new je({
                    mapValue: {
                ...
                g.document;
                var m = $t(t, g.document), w = g.readTime ? Yt(g.readTime) : P.min(), _ = new Qe(m, w), b = g.removedTargetIds || [];
                n = new yt([], b, _.key, _);
            ...
            return e.targetIds && e.targetIds.length ? P.min() : e.readTime ? Yt(e.readTime) : P.min();
        }(t);
    ...
    return t.prototype.fh = function(t) {
                                    ...
                                    return o = e.sent(), s = new Map, o.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = $t(t, e.found.name), r = Yt(e.found.updateTime), i = new je({
                                                    mapValue: {
                                                ...
                                                var n = $t(t, e.missing), r = Yt(e.readTime);
                                                return new Qe(n, r);
                                            }(t, e) : p();
                                        }(r.serializer, t);
        ...
        this.write([ new Ce(t, this.Ue(t)) ]), this._h.add(t);
...
n) {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    // PORTING NOTE: Multi-tab only.
                    this.su.pa(t, "rejected", n), r = this.cu.get(t), (i = r && r.key) ? (o = (o = new Y(R.P)).nt(i, new Qe(i, P.min())), 
    ...
    /** Reject all outstanding callbacks waiting for pending writes to complete. */ t.prototype.vu = function(t) {
        ...
        n || (n = new Y(m)), n = n.nt(t, e), this._u[this.currentUser.lo()] = n;
    }, 
    /**
    ...
    t.prototype.yu = function(t, e) {
        ...
        for (var n = 0, r = e; n < r.length; n++) {
            var i = r[n];
            i instanceof Xr ? (this.lu.lr(i.key, t), this.Cu(i)) : i instanceof Jr ? (c("SyncEngine", "Document no longer in limbo: " + i.key), 
        ...
        return e.__awaiter(this, void 0, void 0, (function() {
            ...
            return e.__generator(this, (function(e) {
                switch (e.label) {
                  ...
                  case 3:
                    return s = e.sent(), u = Ln(s, "Initialization of query '" + Xe(t.query) + "' failed"), 
    ...
    return t.prototype.$i = function(t) {
        ...
        // collection, rather than to perform individual lookups.
            ...
            var u = o.Hu(e, s);
            return (e.En() || e.mn()) && o.Ba(e.en, u, i, n) ? o.zu(t, e) : (h() <= r.LogLevel.DEBUG && c("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Xe(e)), 
    ...
    t.prototype.Ba = function(t, e, n, r) {
        ...
        return h() <= r.LogLevel.DEBUG && c("IndexFreeQueryEngine", "Using full collection scan to execute query:", Xe(e)), 
    ...
    return t.prototype.Ju = function(t) {
        ...
        for (var s = 0, u = r; s < u.length; s++) {
            var a = u[s];
            this.Xu = this.Xu.add(new Sn(a.key, i)), this.Wn.Cs(t, a.key.path.g());
        }
        return yn.resolve(o);
        ...
        var n = this, r = new Sn(e, 0), i = new Sn(e, Number.POSITIVE_INFINITY), o = [];
        ...
        return e.forEach((function(t) {
            var e = new Sn(t, 0), i = new Sn(t, Number.POSITIVE_INFINITY);
        ...
        // because it precedes all other segments in an ordered traversal.
                R.W(i) || (i = i.child(""));
        var o = new Sn(new R(i), 0), s = new $(m);
        ...
        var n = new Sn(e, 0), r = this.Xu.Ct(n);
    ...
    t.prototype.ir = function(t) {
        ...
        for (var r = it(), i = new R(e.path.child("")), o = this.docs.ut(i)
...
var Ni = /** @class */ function() {
    ...
    return t.prototype.Cl = function(t) {
        ...
        var e = U.N(t);
        d(ae(e));
        var n = new b(e.get(1), e.get(3)), r = new R(e.p(5));
    ...
    return Object.defineProperty(t.prototype, "Gl", {
        ...
        On("Firestore.settings", arguments, 1), Cn("Firestore.settings", "object", 1, t);
        var e = new Ti(t);
                ...
                return t = new wn, [ 2 /*return*/ , (this.Ll.Js((function() {
                    return e.__awaiter(n, void 0, void 0, (function() {
                        ...
                        return e.__generator(this, (function(e) {
                            switch (e.label) {
                              case 0:
                                return e.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , this.Wl.clearPersistence(this.Jr, this.Ul) ];
        ...
        Cn("Firestore.onSnapshotsInSync", "function", 1, t);
        var e = {
            next: t
        };
        return Li(this.ql, e);
 ...
 */        if (!n || "string" != typeof n) throw new D(T.INVALID_ARGUMENT, "projectId must be a string in FirebaseApp.options");
        ...
        return On("Firestore.collection", arguments, 1), Cn("Firestore.collection", "non-empty string", 1, t), 
        this.Ml(), new ji(U.N(t), this, 
        /* converter= */ null);
    }, t.prototype.doc = function(t) {
        return On("Firestore.doc", arguments, 1), Cn("Firestore.doc", "non-empty string", 1, t), 
        this.Ml(), Ui.Zl(U.N(t), this, 
        /* converter= */ null);
    }, t.prototype.collectionGroup = function(t) {
        if (On("Firestore.collectionGroup", arguments, 1), Cn("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.Ml(), new xi(new He(U.k(), t), this, 
        /* converter= */ null);
    }, t.prototype.runTransaction = function(t) {
        var e = this;
        return On("Firestore.runTransaction", arguments, 1), Cn("Firestore.runTransaction", "function", 1, t), 
...
var Pi = /** @class */ function() {
    ...
    return t.prototype.get = function(t) {
        ...
        return this.n_.fh([ n.Zr ]).then((function(t) {
            ...
            var r = t[0];
            if (r instanceof Qe) return new Ri(e.e_, n.Zr, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.to);
            if (r instanceof ze) return new Ri(e.e_, n.Zr, r, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, n.to);
            throw p();
        }));
    }, t.prototype.set = function(t, e, n) {
        xn("Transaction.set", arguments, 2, 3);
    ...
    return t.prototype.set = function(t, e, n) {
        xn("WriteBatch.set", arguments, 2, 3), this.r_();
        ...
        return this.s_ = this.s_.concat(new Ce(e.Zr, Ne.je())), this;
    }, t.prototype.commit = function() {
    ...
    return e.__extends(n, t), n.Zl = function(t, e, r) {
        ...
        if (On("DocumentReference.collection", arguments, 1), Cn("DocumentReference.collection", "non-empty string", 1, t), 
        ...
        if (!(t instanceof n)) throw Yn("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.Zr.isEqual(t.Zr) && this.to === t.to;
    }, n.prototype.set = function(t, e) {
        xn("DocumentReference.set", arguments, 1, 2), e = Fi("DocumentReference.set", e);
        ...
        return On("DocumentReference.delete", arguments, 0), this.ql.write([ new Ce(this.Zr, Ne.je()) ]);
    }, n.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        xn("DocumentReference.onSnapshot", arguments, 1, 4);
        var s = {
        ...
        } else Cn("DocumentReference.onSnapshot", "function", u, i[u]), qn("DocumentReference.onSnapshot", "function", u + 1, i[u + 1]), 
        ...
        var e = this;
        return xn("DocumentReference.get", arguments, 0, 1), Bi("DocumentReference.get", t), 
        t && "cache" === t.source ? this.firestore.Ml().yl(this.Zr).then((function(t) {
            return new Ri(e.firestore, e.Zr, t, 
    ...
    n.prototype.o_ = function(t) {
        ...
        return new Ri(this.firestore, this.Zr, e, t.fromCache, t.hasPendingWrites, this.to);
    }, n;
}(gr);
...
var Si = /** @class */ function() {
    ...
    return t.prototype.data = function(t) {
        var e = this;
        if (xn("DocumentSnapshot.data", arguments, 0, 1), t = Gi("DocumentSnapshot.data", t), 
        this.h_) {
        ...
        var n = this;
        if (xn("DocumentSnapshot.get", arguments, 1, 2), e = Gi("DocumentSnapshot.get", e), 
        this.h_) {
        ...
        get: function() {
            return new Si(this.u_, this.a_);
        },
        enumerable: !1,
        configurable: !0
    }), t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Yn("isEqual", "DocumentSnapshot", 1, e);
...
var xi = /** @class */ function(t) {
    ...
    return e.__extends(n, t), n.prototype.where = function(t, e, r) {
        ...
        var r;
        if (xn("Query.orderBy", arguments, 1, 2), qn("Query.orderBy", "non-empty string", 2, e), 
        ...
        return On("Query.limit", arguments, 1), Cn("Query.limit", "number", 1, t), Xn("Query.limit", 1, t), 
        new n(this.c_.ln(t), this.firestore, this.to);
    }, n.prototype.limitToLast = function(t) {
        return On("Query.limitToLast", arguments, 1), Cn("Query.limitToLast", "number", 1, t), 
        Xn("Query.limitToLast", 1, t), new n(this.c_._n(t), this.firestore, this.to);
        ...
        if (!(t instanceof n)) throw Yn("isEqual", "Query", 1, t);
    ...
    /** Helper function to create a bound from a document or fields */ n.prototype.A_ = function(t, n, r, i) {
        if (Hn(t, 1, n), n instanceof Ri) return On(t, e.__spreadArrays([ n ], r), 1), this.E_(t, n.h_, i);
        var o = [ n ].concat(r);
        return this.m_(t, o, i);
    }, n.prototype.onSnapshot = function() {
        for (var t, e, n, r = this, i = [], o = 0; o < arguments.length; o++) i[o] = arguments[o];
        xn("Query.onSnapshot", arguments, 1, 4);
        var s = {}, u = 0;
        ...
        } else Cn("Query.onSnapshot", "function", u, i[u]), qn("Query.onSnapshot", "function", u + 1, i[u + 1]), 
        ...
        return Mi(this.c_), Ci(this.firestore.Ml(), this.c_, s, h);
    }, n.prototype.get = function(t) {
        var e = this;
        xn("Query.get", arguments, 0, 1), Bi("Query.get", t), Mi(this.c_);
    ...
    t.prototype.E_ = function(t, e, n) {
        ...
        for (var r = [], i = 0, o = this.c_.orderBy; i < o.length; i++) {
            var s = o[i];
            if (s.field.L()) r.push(Rt(this.Jr, e.key)); else {
    ...
    t.prototype.m_ = function(t, e, n) {
        ...
        for (var i = [], o = 0; o < e.length; o++) {
            ...
            if (r[o].field.L()) {
                ...
                if (!R.W(u)) throw new D(T.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by FieldPath.documentId(), the value passed to " + t + "() must result in a valid document path, but '" + u + "' is not because it contains an odd number of segments.");
                var a = new R(u);
                i.push(Rt(this.Jr, a));
            } else {
    ...
    t.prototype.f_ = function(t) {
        if ("string" == typeof t) {
            ...
            if (!R.W(e)) throw new D(T.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, but '" + e + "' is not because it has an odd number of segments (" + e.length + ").");
            return Rt(this.Jr, new R(e));
        }
        if (t instanceof gr) return Rt(this.Jr, t.Zr);
...
var qi = /** @class */ function() {
    function t(t, e, n, r) {
        ...
        this.metadata = new Si(n.hasPendingWrites, n.fromCache);
    }
    return Object.defineProperty(t.prototype, "docs", {
        ...
        var n = this;
        xn("QuerySnapshot.forEach", arguments, 1, 2), Cn("QuerySnapshot.forEach", "function", 1, t), 
        this.P_.docs.forEach((function(r) {
            t.call(e, n.p_(r, n.metadata.fromCache, n.P_.Mt.has(r.key)));
        }));
    }, Object.defineProperty(t.prototype, "query", {
        get: function() {
            return new xi(this.R_, this.e_, this.to);
        },
        enumerable: !1,
        configurable: !0
    ...
    /** Check the equality. The call can be very expensive. */ t.prototype.isEqual = function(e) {
        if (!(e instanceof t)) throw Yn("isEqual", "QuerySnapshot", 1, e);
    ...
    return e.__extends(n, t), Object.defineProperty(n.prototype, "id", {
        ...
        get: function() {
            ...
            return t._() ? null : new Ui(new R(t), this.firestore, 
            /* converter= */ null);
        },
        enumerable: !1,
        configurable: !0
        ...
        xn("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = g.t()), Cn("CollectionReference.doc", "non-empty string", 1, t);
        var e = U.N(t);
        return Ui.Zl(this.c_.path.child(e), this.firestore, this.to);
    }, n.prototype.add = function(t) {
        On("CollectionReference.add", arguments, 1), Cn("CollectionReference.add", "object", 1, this.to ? this.to.toFirestore(t) : t);
        var e = this.doc();
...
function zi(t, e, n) {
    ...
    throw Yn(t, "DocumentReference", 1, e);
}
