...
function J(t) {
    ...
    if (null === e.K) {
        let t = e.path.N();
        null !== e.collectionGroup && (t += "|cg:" + e.collectionGroup), t += "|f:", t += e.filters.map(t => Dn(t)).join(","), 
        t += "|ob:", t += e.orderBy.map(t => {
            return (e = t).field.N() + e.dir;
            var e;
        }).join(","), K(e.limit) || (t += "|l:", t += e.limit), e.startAt && (t += "|lb:", 
        t += Mn(e.startAt)), e.endAt && (t += "|ub:", t += Mn(e.endAt)), e.K = t;
    }
    return e.K;
}
...
function Z(t, e) {
    ...
    !(n instanceof Sn && s instanceof Sn && n.op === s.op && n.field.isEqual(s.field) && Bt(n.value, s.value))) return !1;
    var n, s;
 ...
 */ class gt {
    ...
    constructor(t) {
        ...
        this.Nt = It(), this.$t = new ut(this.P);
    }
    /**
 ...
 */ class bt {
    ...
    static Gt(t, e) {
        const n = new Map;
        return n.set(t, vt.zt(t, e)), new bt(B.min(), n, Vt(), wt(), Rt());
    }
}
...
class Nt {
     ...
     */    Ne(t) {
        ...
        this.Ie.forEach((n, s) => {
            ...
            if (i) {
                if (n.Ht && tt(i.target)) {
                    ...
                    null !== this.me.get(e) || this.$e(s, e) || this.ge(s, e, new Rn(e, t));
                }
        ...
        return this.me = wt(), this.Ae = $t(), this.Re = new _t(v), s;
    }
    /**
     ...
     * from all documents).
     */    Se(t) {
        this.Ie.set(t, new Ft), this.Ee.xe(t).forEach(e => {
...
/** Extracts the backend's type order for the provided value. */ function Lt(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? xt(t) ? 4 /* ServerTimestampValue */ : 10 /* ObjectValue */ : V();
}
...
/** Tests `left` and `right` for equality based on the backend semantics. */ function Bt(t, e) {
    ...
    switch (n) {
      ...
      case 9 /* ArrayValue */ :
        return S(t.arrayValue.values || [], e.arrayValue.values || [], Bt);
...
function jt(t) {
    ...
    j.q(n).toString()) : "geoPointValue" in t ? `geo(${(e = t.geoPointValue).latitude},${e.longitude})` : "arrayValue" in t ? function(t) {
        let e = "[", n = !0;
 ...
 */ (o);
        ...
        s.document;
        const i = de(t, s.document), r = s.readTime ? ce(s.readTime) : B.min(), o = new Rn(i, r), h = s.removedTargetIds || [];
        n = new St([], h, o.key, o);
...
function Ve(t, e) {
    const n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? Ze.updateTime(ce(t.updateTime)) : void 0 !== t.exists ? Ze.exists(t.exists) : Ze.Qe();
    }(e.currentDocument) : Ze.Qe();
    if (e.update) {
        e.update.name;
    ...
    if (e.transform) {
        const s = de(t, e.transform.document), i = e.transform.fieldTransforms.map(e => function(t, e) {
            let n = null;
            if ("setToServerValue" in e) g("REQUEST_TIME" === e.setToServerValue), n = new qe; else if ("appendMissingElements" in e) {
...
function pe(t, e) {
    ...
    const i = function(t) {
        ...
        const e = t.map(t => t instanceof Sn ? 
        // visible for testing
        function(t) {
            if ("==" /* EQUAL */ === t.op) {
...
function be(t) {
    ...
    n.where && (r = function t(e) {
        return e ? void 0 !== e.unaryFilter ? [ $e(e) ] : void 0 !== e.fieldFilter ? [ Ne(e) ] : void 0 !== e.compositeFilter ? e.compositeFilter.filters.map(e => t(e)).reduce((t, e) => t.concat(e)) : V() : [];
    }(n.where));
    let o = [];
    n.orderBy && (o = n.orderBy.map(t => {
        return new Bn(Fe((e = t).field), 
        // visible for testing
        function(t) {
            switch (t) {
              case "ASCENDING":
    ...
    let u = null;
    return n.endAt && (u = De(n.endAt)), new Vn(e, i, o, r, h, "F" /* First */ , a, u).We();
}
...
function Ne(t) {
    return Sn.create(Fe(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function $e(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        ...
        return Sn.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        const n = Fe(t.unaryFilter.field);
        return Sn.create(n, "==" /* EQUAL */ , {
...
/** Transforms an array value via a remove operation. */ class We extends Me {
    constructor(t) {
        super(), this.elements = t;
    }
}
...
function Je(t, e) {
    return t.field.isEqual(e.field) && function(t, e) {
        return t instanceof Ue && e instanceof Ue || t instanceof We && e instanceof We ? S(t.elements, e.elements, Bt) : t instanceof Ke && e instanceof Ke ? Bt(t.Be, e.Be) : t instanceof qe && e instanceof qe;
 ...
 */ function hn(t) {
    return t instanceof An ? t.version : B.min();
}
 ...
 */ class Vn {
    ...
    get orderBy() {
        if (null === this.sn) {
            ...
            t.O() || this.sn.push(new Bn(t)), this.sn.push(new Bn(W.L(), "asc" /* ASCENDING */)); else {
                let t = !1;
    ...
    cn(t) {
        ...
        return new Vn(this.path, this.collectionGroup, this.en.slice(), e, this.limit, this.nn, this.startAt, this.endAt);
    }
    ln(t) {
        // TODO(dimond): validate that orderBy does not list the same key twice.
        const e = this.en.concat([ t ]);
        return new Vn(this.path, this.collectionGroup, e, this.filters.slice(), this.limit, this.nn, this.startAt, this.endAt);
    }
    _n(t) {
        return new Vn(this.path, this.collectionGroup, this.en.slice(), this.filters.slice(), t, "F" /* First */ , this.startAt, this.endAt);
    }
    fn(t) {
        return new Vn(this.path, this.collectionGroup, this.en.slice(), this.filters.slice(), t, "L" /* Last */ , this.startAt, this.endAt);
    }
    dn(t) {
        return new Vn(this.path, this.collectionGroup, this.en.slice(), this.filters.slice(), this.limit, this.nn, t, this.endAt);
    }
    wn(t) {
        return new Vn(this.path, this.collectionGroup, this.en.slice(), this.filters.slice(), this.limit, this.nn, this.startAt, t);
    }
    /**
    ...
    an() {
        for (const t of this.filters) if (t instanceof Sn && t.An()) return t.field;
        return null;
    }
    // Checks if any of the provided Operators are included in the query and
    // returns the first one that is, or null if none are.
    Rn(t) {
        for (const e of this.filters) if (e instanceof Sn && t.indexOf(e.op) >= 0) return e.op;
        return null;
    }
    Pn() {
        return tt(this.We());
     ...
     * representation.
     */    We() {
        if (!this.rn) if ("F" /* First */ === this.nn) this.rn = Y(this.path, this.collectionGroup, this.orderBy, this.filters, this.limit, this.startAt, this.endAt); else {
            ...
            // We need to swap the cursors to match the now-flipped query ordering.
                        const e = this.endAt ? new xn(this.endAt.position, !this.endAt.before) : null, n = this.startAt ? new xn(this.startAt.position, !this.startAt.before) : null;
            // Now return as a LimitType.First query.
            this.rn = Y(this.path, this.collectionGroup, t, this.filters, this.limit, e, n);
        }
        return this.rn;
    }
    on(t) {}
...
function pn(t) {
    return `Query(target=${X(t.We())}; limitType=${t.nn})`;
}
 ...
 */ (t, e) && function(t, e) {
    ...
    /** Makes sure a document is within the bounds, if provided. */ (t, e) && function(t, e) {
        if (t.startAt && !On(t.startAt, t.orderBy, e)) return !1;
        if (t.endAt && On(t.endAt, t.orderBy, e)) return !1;
        return !0;
    }
    /**
...
class Sn extends class {} {
     ...
     */    static create(t, e, n) {
        if (t.O()) return "in" /* IN */ === e ? new Fn(t, n) : new Cn(t, e, n);
        if (Xt(n)) {
        ...
        return "array-contains" /* ARRAY_CONTAINS */ === e ? new Nn(t, n) : "in" /* IN */ === e ? new $n(t, n) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new kn(t, n) : new Sn(t, e, n);
    }
    matches(t) {
        const e = t.field(this.field);
        // Only compare types with matching backend order (such as double and int).
                return null !== e && Lt(this.value) === Lt(e) && this.gn(Ut(e, this.value));
    }
    gn(t) {
        switch (this.op) {
          case "<" /* LESS_THAN */ :
...
class Cn extends Sn {
    constructor(t, e, n) {
        super(t, e, n), this.key = j.q(n.referenceValue);
    }
    matches(t) {
...
/** Filter that matches on key fields within an array. */ class Fn extends Sn {
    constructor(t, e) {
        super(t, "in" /* IN */ , e), this.keys = (e.arrayValue.values || []).map(t => j.q(t.referenceValue));
    }
    matches(t) {
...
/** A Filter that implements the array-contains operator. */ class Nn extends Sn {
    constructor(t, e) {
        super(t, "array-contains" /* ARRAY_CONTAINS */ , e);
    }
    matches(t) {
        const e = t.field(this.field);
        return Jt(e) && qt(e.arrayValue, this.value);
    }
}

/** A Filter that implements the IN operator. */ class $n extends Sn {
    constructor(t, e) {
        super(t, "in" /* IN */ , e);
    }
    matches(t) {
...
/** A Filter that implements the array-contains-any operator. */ class kn extends Sn {
    constructor(t, e) {
        super(t, "array-contains-any" /* ARRAY_CONTAINS_ANY */ , e);
    }
    matches(t) {
        const e = t.field(this.field);
        return !(!Jt(e) || !e.arrayValue.values) && e.arrayValue.values.some(t => qt(this.value.arrayValue, t));
    }
}
 ...
 */ function On(t, e, n) {
    ...
    for (let i = 0; i < t.position.length; i++) {
        ...
        if (r.field.O()) s = j.P(j.q(o.referenceValue), n.key); else {
...
class Qn {
     ...
     */    vn(t, e) {
        ...
        for (const n of this.baseMutations) n.key.isEqual(t) && (e = sn(n, e, e, this.yn));
        const n = e;
        // Second, apply all user-provided mutations.
                for (const s of this.mutations) s.key.isEqual(t) && (e = sn(s, e, n, this.yn));
        return e;
    }
    /**
 ...
 */ class jn {
    ...
    next(t, e) {
        return this.kn && V(), this.kn = !0, this.$n ? this.error ? this.xn(e, this.error) : this.Mn(t, this.result) : new jn((n, s) => {
            this.Fn = e => {
    ...
    Ln(t) {
        try {
            const e = t();
            return e instanceof jn ? e : jn.resolve(e);
        } catch (t) {
            return jn.reject(t);
        }
    }
    Mn(t, e) {
        return t ? this.Ln(() => t(e)) : jn.resolve(e);
    }
    xn(t, e) {
        return t ? this.Ln(() => t(e)) : jn.reject(e);
    }
    static resolve(t) {
        return new jn((e, n) => {
            e(t);
     ...
     */    static qn(t) {
        let e = jn.resolve(!1);
        for (const n of t) e = e.next(t => t ? jn.resolve(t) : n());
        return e;
    }
    static forEach(t, e) {
        const n = [];
 ...
 */ class Kn {
    constructor() {
        ...
        this.Un = new x(t => t.toString(), (t, e) => t.isEqual(e)), this.Qn = !1;
    }
    set readTime(t) {
        this.Wn = t;
    }
     ...
     */    zn(t, e) {
        ...
        return void 0 !== n ? jn.resolve(n) : this.Hn(t, e);
    }
    /**
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const Gn = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.";
 ...
 */ class Hn {
    ...
    fs(t, e) {
        ...
        return this.rs(t, new j(e)).next(t => {
            let e = It();
    ...
    ds(t, e, n) {
        ...
        let i = It();
        return this.ss.Ts(t, s).next(r => jn.forEach(r, r => {
    ...
    ws(t, e, n) {
        ...
        this.Is(t, i, s).next(t => {
            ...
            for (const t of i) for (const e of t.mutations) {
                const n = e.key, i = s.get(n), r = sn(e, i, i, t.yn);
 ...
 */ class Yn {
 ...
 // do nothing
        ...
        return new Yn(t, e.fromCache, n, s);
    }
}
...
class Zn {
     ...
     */    xs(t) {
        ...
        // Guard against lastAttemptTime being in the future due to a clock change.
                s > 0 && A("ExponentialBackoff", `Backing off for ${s} ms ` + `(base delay: ${this.Fs} ms, ` + `delay with jitter: ${e} ms, ` + `last attempt: ${n} ms ago)`), 
 ...
 */ function ss(t) {
    ...
    const e = t.length;
    if (g(e >= 2), 2 === e) return g("" === t.charAt(0) && "" === t.charAt(1)), U.k();
 ...
 */ class is {
    ...
    Us(t, e) {
        return this.qs.add(e), jn.resolve();
    }
    Ts(t, e) {
        return jn.resolve(this.qs.getEntries(e));
    }
}
 ...
 * limitations under the License.
 */
/** Serializer for values stored in the LocalStore. */ class as {
    constructor(t) {
        this.Ks = t;
    }
}
...
/** Decodes a remote document from storage locally to a Document. */ function us(t, e) {
    ...
    if (e.noDocument) {
        const t = j.j(e.noDocument.path), n = ds(e.noDocument.readTime);
        return new Rn(t, n, {
            hasCommittedMutations: !!e.hasCommittedMutations
        });
    }
    if (e.unknownDocument) {
        const t = j.j(e.unknownDocument.path), n = ds(e.unknownDocument.version);
        return new Pn(t, n);
    }
    return V();
}

/** Encodes a document for storage locally. */ function cs(t, e, n) {
    const s = ls(n), i = e.key.path.p().F();
    if (e instanceof An) {
        const n = function(t, e) {
            return {
                name: fe(t, e.key),
    ...
    if (e instanceof Rn) {
        const t = e.key.path.F(), n = fs(e.version), r = e.hasCommittedMutations;
        return new Js(
        /* unknownDocument= */ null, new Hs(t, n), 
        /* document= */ null, r, s, i);
    }
    if (e instanceof Pn) {
        const t = e.key.path.F(), n = fs(e.version);
        return new Js(new Ys(t, n), 
        /* noDocument= */ null, 
        /* document= */ null, 
...
function ws(t, e) {
    const n = (e.baseMutations || []).map(e => Ve(t.Ks, e)), s = e.mutations.map(e => Ve(t.Ks, e)), i = L.fromMillis(e.localWriteTimeMs);
    return new Qn(e.batchId, i, n, s);
}

/** Decodes a DbTarget into TargetData */ function Ts(t) {
    const e = ds(t.readTime), n = void 0 !== t.lastLimboFreeSnapshotVersion ? ds(t.lastLimboFreeSnapshotVersion) : B.min();
    let s;
    return s = void 0 !== t.query.documents ? function(t) {
        g(1 === t.documents.length);
        const e = t.documents[0];
        return Vn.hn(Te(e)).We();
    }(t.query) : be(t.query), new st(s, t.targetId, 0 /* Listen */ , t.lastListenSequenceNumber, e, n, nt.fromBase64String(t.resumeToken));
}

/** Encodes TargetData into a DbTarget for storage locally. */ function Es(t, e) {
    const n = fs(e.X), s = fs(e.lastLimboFreeSnapshotVersion);
    let i;
    i = tt(e.target) ? ye(t.Ks, e.target) : pe(t.Ks, e.target);
    // We can't store the resumeToken as a ByteString in IndexedDb, so we
    // convert it to a base64 string for storage.
        const r = e.resumeToken.toBase64();
    // lastListenSequenceNumber is always 0 until we do real GC.
        return new Zs(e.targetId, J(e.target), n, r, e.sequenceNumber, s, i);
}
...
class Is {
    ...
    zn(t, e) {
        return As(t).get(Rs(e)).next(t => this.zs(t));
    }
    /**
     ...
     */    Xs(t, e) {
        ...
        return this.Js(t, e, (t, e) => {
            const i = this.zs(e);
            i ? (n = n.nt(t, i), s = s.nt(t, Ps(e))) : (n = n.nt(t, null), s = s.nt(t, 0));
        }).next(() => ({
            Zs: n,
            ti: s
        }));
    ...
    _s(t, e, n) {
        ...
        return As(t).ei(r, (t, n, r) => {
            ...
            const o = us(this.serializer, n);
            e.path.D(o.key.path) ? o instanceof An && bn(e, o) && (s = s.nt(o.key, o)) : r.done();
        }).next(() => s);
    }
    /**
    ...
    si(t, e) {
        let n = wt(), s = ls(e);
        const i = As(t), r = IDBKeyRange.lowerBound(s, !0);
        return i.ei({
    ...
    ri(t) {
        ...
        return e.ei({
            ...
            e.readTime && (n = _s(e.readTime)), s.done();
        }).next(() => n);
    }
    oi(t) {
        return new Is.hi(this, !!t && t.ai);
    }
    ui(t) {
        return this.getMetadata(t).next(t => t.byteSize);
    }
    getMetadata(t) {
        return ms(t).get(Xs.key).next(t => (g(!!t), t));
    }
    Gs(t, e) {
        return ms(t).put(Xs.key, e);
    }
    /**
     ...
     */    zs(t) {
        if (t) {
            const e = us(this.serializer, t);
            return e instanceof Rn && e.version.isEqual(B.min()) ? null : e;
        }
        return null;
    }
}
 ...
 */ function ms(t) {
    return Ds.js(t, Xs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the remoteDocuments object store.
 */ function As(t) {
    return Ds.js(t, Js.store);
}
 ...
 * limitations under the License.
 */
/** Offset to ensure non-overlapping target ids. */ Is.hi = class extends Kn {
    /**
    ...
    constructor(t, e) {
        ...
        this.li = new x(t => t.toString(), (t, e) => t.isEqual(e));
    }
    Jn(t) {
        const e = [];
        ...
        return this.Un.forEach((i, r) => {
            ...
            if (r) {
                const h = cs(this.ci.serializer, r, this.readTime);
                s = s.add(i.path.p());
                const a = Ps(h);
                ...
                const n = cs(this.ci.serializer, new Rn(i, B.min()), this.readTime);
                e.push(this.ci.jn(t, i, n));
            } else e.push(this.ci.Gn(t, i));
        }), s.forEach(n => {
            e.push(this.ci.ss.Us(t, n));
        }), e.push(this.ci.updateMetadata(t, n)), jn.Bn(e);
    }
    Hn(t, e) {
 ...
 */ class gs {
    ...
    Ti(t) {
        return this.Ei(t).next(e => {
            const n = new Vs(e.highestTargetId);
            return e.highestTargetId = n.next(), this.Ii(t, e).next(() => e.highestTargetId);
        });
    }
    mi(t) {
        return this.Ei(t).next(t => B.I(new L(t.lastRemoteSnapshotVersion.seconds, t.lastRemoteSnapshotVersion.nanoseconds)));
    }
    Ai(t) {
    ...
    pi(t, e) {
        return this.bi(t, e.targetId).next(() => ys(t).delete(e.targetId)).next(() => this.Ei(t)).next(e => (g(e.targetCount > 0), 
    ...
    Ei(t) {
        return ps(t).get(ei.key).next(t => (g(null !== t), t));
    }
    Ii(t, e) {
        return ps(t).put(ei.key, e);
    }
    Vi(t, e) {
        return ys(t).put(Es(this.serializer, e));
    }
    /**
    ...
    Ci(t, e, n) {
        ...
        return e.forEach(e => {
            const r = ts(e.path);
            s.push(i.put(new ti(n, r))), s.push(this.wi.Fi(t, n, e));
        }), jn.Bn(s);
    }
    Ni(t, e, n) {
        // PORTING NOTE: The reverse index (documentsTargets) is maintained by
        // IndexedDb.
        const s = bs(t);
        return jn.forEach(e, e => {
            const i = ts(e.path);
            return jn.Bn([ s.delete([ n, i ]), this.wi.$i(t, n, e) ]);
        });
    }
    bi(t, e) {
        const n = bs(t), s = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(s);
    }
    ki(t, e) {
        ...
        return s.ei({
            ...
            const s = ss(t[1]), r = new j(s);
            i = i.add(r);
        }).next(() => i);
    }
    Mi(t, e) {
        const n = ts(e.path), s = IDBKeyRange.bound([ n ], [ D(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        let i = 0;
        return bs(t).ei({
    ...
    // PORTING NOTE: Multi-tab only.
    Me(t, e) {
        return ys(t).get(e).next(t => t ? Ts(t) : null);
    }
}
 ...
 */ function ys(t) {
    return Ds.js(t, Zs.store);
}

/**
 * Helper to get a typed SimpleDbStore for the target globals object store.
 */ function ps(t) {
    return Ds.js(t, ei.store);
}

/**
 * Helper to get a typed SimpleDbStore for the document target object store.
 */ function bs(t) {
    return Ds.js(t, ti.store);
}
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ const vs = "Failed to obtain exclusive access to the persistence layer. To allow shared access, make sure to invoke `enablePersistence()` with `synchronizeTabs:true` in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.";
 ...
 */ class Ds {
    ...
    u) {
        ...
        this.zi = t => Promise.resolve(), !Ds.Hi()) throw new O(M.UNIMPLEMENTED, "This platform is either missing IndexedDB or is known to have an incomplete implementation. Offline persistence has been disabled.");
        this.wi = new Ns(this, s), this.Yi = e + "main", this.serializer = new as(h), this.Ji = new gs(this.wi, this.serializer), 
        this.ss = new os, this.es = new Is(this.serializer, this.ss), this.window && this.window.localStorage ? this.Xi = this.window.localStorage : (this.Xi = null, 
    ...
    static js(t, e) {
        if (t instanceof Ss) return oi.js(t.Oi, e);
        throw V();
    }
    /**
     ...
     */    start() {
        return oi.Zi(this.Yi, Us, new Qs(this.serializer)).then(t => (this.tr = t, this.er())).then(() => {
            if (!this.isPrimary && !this.allowTabSynchronization) 
            // Fail `start()` if `synchronizeTabs` is disabled and we cannot
            // obtain the primary lease.
            throw new O(M.FAILED_PRECONDITION, vs);
            return this.nr(), this.sr(), this.ir(), this.runTransaction("getHighestListenSequenceNumber", "readonly", t => this.Ji.Ai(t));
        }).then(t => {
            this.Ui = new Jn(t, this.Bi);
        }).then(() => {
            this.Qi = !0;
     ...
     * primary lease.
     */    er() {
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", t => Fs(t).put(new ii(this.clientId, Date.now(), this.networkEnabled, this.inForeground)).next(() => {
    ...
    lr(t) {
        return Cs(t).get(js.key).next(t => jn.resolve(this.Er(t)));
    }
    Ir(t) {
        return Fs(t).delete(this.clientId);
    }
    /**
     ...
     */    async mr() {
        if (this.isPrimary && !this.Ar(this.Gi, 18e5)) {
            ...
            const t = await this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", t => {
                const e = Ds.js(t, ii.store);
                return e.Ws().next(t => {
                    const n = this.Rr(t, 18e5), s = t.filter(t => -1 === n.indexOf(t));
                    // Delete metadata for clients that are no longer considered active.
                    return jn.forEach(s, t => e.delete(t.clientId)).next(() => s);
                });
            }).catch(() => []);
     ...
     */    dr(t) {
        if (this.qi) return jn.resolve(!0);
        return Cs(t).get(js.key).next(e => {
            ...
            return !(!this.networkEnabled || !this.inForeground) || Fs(t).Ws().next(t => void 0 === this.Rr(t, 5e3).find(t => {
     ...
     * PORTING NOTE: This is only used for Web multi-tab.
     */    Sr() {
        return this.runTransaction("getActiveClients", "readonly", t => Fs(t).Ws().next(t => this.Rr(t, 18e5).map(t => t.clientId)));
    }
    get or() {
        return this.Qi;
    }
    Dr(t) {
        return xs.Cr(t, this.serializer, this.ss, this.wi);
    }
    Fr() {
        return this.Ji;
    }
    ...
    runTransaction(t, e, n) {
        ...
        // are the only reader/writer.
                return this.tr.runTransaction(s, ri, s => (i = new Ss(s, this.Ui ? this.Ui.next() : Jn.ps), 
        "readwrite-primary" === e ? this.lr(i).next(t => !!t || this.dr(i)).next(e => {
            ...
            this.bs._r(() => this.zi(!1)), new O(M.FAILED_PRECONDITION, Gn);
            return n(i);
    ...
    // be turned off.
    kr(t) {
        return Cs(t).get(js.key).next(t => {
            if (null !== t && this.Ar(t.leaseTimestampMs, 5e3) && !this.Vr(t.ownerId) && !this.Er(t) && !(this.qi || this.allowTabSynchronization && t.allowTabSynchronization)) throw new O(M.FAILED_PRECONDITION, vs);
        });
    }
    /**
     ...
     */    Tr(t) {
        const e = new js(this.clientId, this.allowTabSynchronization, Date.now());
        return Cs(t).put(js.key, e);
    }
    static Hi() {
        return oi.Hi();
    }
    /** Checks the primary lease and removes it if we are the current primary. */    wr(t) {
        const e = Cs(t);
        return e.get(js.key).next(t => this.Er(t) ? (A("IndexedDbPersistence", "Releasing primary lease."), 
        e.delete(js.key)) : jn.resolve());
    }
 ...
 */ function Fs(t) {
    return Ds.js(t, ii.store);
}

/** Provides LRU functionality for IndexedDB persistence. */ class Ns {
    constructor(t, e) {
        this.db = t, this.xr = new gi(this, e);
    }
    Mr(t) {
        const e = this.Or(t);
     ...
     */    Ur(t, e) {
        ...
        return function(t, e) {
            let n = !1;
            return qs(t).Qr(s => Ms(t, s, e).next(t => (t && (n = !0), jn.resolve(!t)))).next(() => n);
        }
        /**
        ...
        return this.Br(t, (r, o) => {
            if (o <= e) {
                const e = this.Ur(t, r).next(e => {
                    ...
                    // removing them.
                    return i++, n.zn(t, r).next(() => (n.Gn(r), bs(t).delete([ 0, ts(r.path) ])));
                });
                s.push(e);
            }
        }).next(() => jn.Bn(s)).next(() => n.apply(t)).next(() => i);
    }
    removeTarget(t, e) {
        const n = e.Z(t.Li);
...
class xs {
    ...
    Yr(t, e, n, s) {
        ...
        return r.add({}).next(o => {
            ...
            const h = new Qn(o, e, n, s), a = function(t, e, n) {
                const s = n.baseMutations.map(e => Pe(t.Ks, e)), i = n.mutations.map(e => Pe(t.Ks, e));
                return new Gs(e, n.batchId, n.yn.toMillis(), s, i);
            }(this.serializer, this.userId, h), u = [];
            let c = new _t((t, e) => v(t.N(), e.N()));
            for (const t of s) {
                const e = zs.key(this.userId, t.key.path, o);
                c = c.add(t.key.path.p()), u.push(r.put(a)), u.push(i.put(e, zs.PLACEHOLDER));
            }
            return c.forEach(e => {
    ...
    Jr(t, e) {
        return Ls(t).get(e).next(t => t ? (g(t.userId === this.userId), ws(this.serializer, t)) : null);
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Xr(t, e) {
        return this.Gr[e] ? jn.resolve(this.Gr[e]) : this.Jr(t, e).next(t => {
            if (t) {
                const n = t.keys();
    ...
    eo(t) {
        ...
        return Ls(t).Ws(Gs.userMutationsIndex, e).next(t => t.map(t => ws(this.serializer, t)));
    }
    os(t, e) {
        // Scan the document-mutation index starting with a prefix starting with
        // the given documentKey.
        const n = zs.prefixForPath(this.userId, e.path), s = IDBKeyRange.lowerBound(n), i = [];
        return Bs(t).ei({
            range: s
        }, (n, s, r) => {
            const [o, h, a] = n, u = ss(h);
    ...
    ls(t, e) {
        ...
        const s = [];
        return e.forEach(e => {
            const i = zs.prefixForPath(this.userId, e.path), r = IDBKeyRange.lowerBound(i), o = Bs(t).ei({
                range: r
            }, (t, s, i) => {
                const [r, o, h] = t, a = ss(o);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            s.push(o);
        }), jn.Bn(s).next(() => this.no(t, n));
    }
    Es(t, e) {
        const n = e.path, s = n.length + 1, i = zs.prefixForPath(this.userId, n), r = IDBKeyRange.lowerBound(i);
    ...
    so(t, e) {
        return Os(t.Oi, this.userId, e).next(n => (t.Zn(() => {
            this.io(e.batchId);
        }), jn.forEach(n, e => this.wi.qr(t, e))));
    }
    /**
    ...
    ro(t) {
        return this.Hr(t).next(e => {
            if (!e) return jn.resolve();
            // Verify that there are no entries in the documentMutations index if
            // the queue is empty.
                        const n = IDBKeyRange.lowerBound(zs.prefixForUser(this.userId)), s = [];
            return Bs(t).ei({
                range: n
            }, (t, e, n) => {
                if (t[0] === this.userId) {
    ...
    oo(t) {
        return qs(t).get(this.userId).next(t => t || new Ks(this.userId, -1, 
        /*lastStreamToken=*/ ""));
    }
}
 ...
 */ function Ms(t, e, n) {
    const s = zs.prefixForPath(e, n.path), i = s[1], r = IDBKeyRange.lowerBound(s);
    let o = !1;
    return Bs(t).ei({
        range: r,
        xi: !0
...
function Os(t, e, n) {
    const s = t.store(Gs.store), i = t.store(zs.store), r = [], o = IDBKeyRange.only(n.batchId);
    let h = 0;
    const a = s.ei({
        range: o
    }, (t, e, n) => (h++, n.delete()));
    ...
    for (const t of n.mutations) {
        const s = zs.key(e, t.key.path, n.batchId);
        r.push(i.delete(s)), u.push(t.key);
    }
    return jn.Bn(r).next(() => u);
}

/**
 * Helper to get a typed SimpleDbStore for the mutations object store.
 */ function Ls(t) {
    return Ds.js(t, Gs.store);
}
 ...
 */ (t));
        ...
        0 !== n && (!function(t) {
            t.deleteObjectStore(ti.store), t.deleteObjectStore(Zs.store), t.deleteObjectStore(ei.store);
        }(t), si(t)), r = r.next(() => 
        /**
 ...
 */ (i))), n < 4 && s >= 4 && (0 !== n && (
        ...
        r = r.next(() => function(t, e) {
            return e.store(Gs.store).Ws().next(n => {
                t.deleteObjectStore(Gs.store), t.createObjectStore(Gs.store, {
                    keyPath: Gs.keyPath,
                    autoIncrement: !0
                }).createIndex(Gs.userMutationsIndex, Gs.userMutationsKeyPath, {
                    unique: !0
 ...
 */ (e);
    ...
    addDocumentGlobal(t) {
        let e = 0;
        return t.store(Js.store).ei((t, n) => {
            e += Ps(n);
        }).next(() => {
            const n = new Xs(e);
    ...
    removeAcknowledgedMutations(t) {
        const e = t.store(Ks.store), n = t.store(Gs.store);
        return e.Ws().next(e => jn.forEach(e, e => {
            const s = IDBKeyRange.bound([ e.userId, -1 ], [ e.userId, e.lastAcknowledgedBatchId ]);
            return n.Ws(Gs.userMutationsIndex, s).next(n => jn.forEach(n, n => {
                g(n.userId === e.userId);
                const s = ws(this.serializer, n);
                return Os(t, e.userId, s).next(() => {});
            }));
        }));
    }
    /**
     ...
     */    ensureSequenceNumbers(t) {
        const e = t.store(ti.store), n = t.store(Js.store);
 ...
 */ (r);
                s.push(e.get(o).next(n => n ? jn.resolve() : (n => e.put(new ti(0, ts(n), t.highestListenSequenceNumber)))(r)));
            }).next(() => jn.Bn(s));
        });
    }
    createCollectionParentIndex(t, e) {
        ...
        const n = e.store(ni.store), s = new rs, i = t => {
            if (s.add(t)) {
                const e = t.S(), s = t.p();
                return n.put({
                    collectionId: e,
        ...
        return e.store(Js.store).ei({
            xi: !0
        }, (t, e) => {
            const n = new U(t);
            return i(n.p());
        }).next(() => e.store(zs.store).ei({
            xi: !0
        }, ([t, e, n], s) => {
            const r = ss(e);
            return i(r.p());
    ...
    rewriteCanonicalIds(t) {
        ...
        return e.ei((t, n) => {
            const s = Ts(n), i = Es(this.serializer, s);
            return e.put(i);
        });
    }
}
...
ni.store = "collectionParents", 
/** Keys are automatically assigned via the collectionId, parent properties. */
ni.keyPath = [ "collectionId", "parent" ];
...
const ri = [ ...[ ...[ ...[ Ks.store, Gs.store, zs.store, Js.store, Zs.store, js.store, ei.store, ti.store ], ii.store ], Xs.store ], ni.store ];
...
class oi {
    constructor(t) {
        ...
        // log on 12.2.
        12.2 === oi.ho(i()) && R("Firestore persistence suffers from a bug in iOS 12.2 Safari that may cause your app to stop working. See https://stackoverflow.com/q/56496296/110915 for details and a potential workaround.");
    }
    /**
     ...
     * objectstores.
     */    static Zi(t, e, n) {
        return A("SimpleDb", "Opening database:", t), new jn((s, i) => {
            ...
            r.onsuccess = t => {
                ...
                n.createOrUpgrade(s, r.transaction, e.oldVersion, Us).next(() => {
                    A("SimpleDb", "Database upgrade to version " + Us + " complete");
                });
            };
        }).On();
    }
    /** Deletes the specified database. */    static delete(t) {
        return A("SimpleDb", "Removing database:", t), _i(window.indexedDB.deleteDatabase(t)).On();
    }
    /** Returns true if IndexedDB is available in the current environment. */    static Hi() {
        ...
        // Check the UA string to find out the browser.
                const t = i(), e = oi.ho(t), n = 0 < e && e < 10, s = oi.uo(t), r = 0 < s && s < 4.5;
        // IE 10
    ...
    async runTransaction(t, e, n) {
        ...
        for (;;) {
            ++i;
            const t = ci.open(this.db, s ? "readonly" : "readwrite", e);
            try {
                const e = n(t).catch(e => (
                // Abort the transaction if there was an error.
                t.abort(e), jn.reject(e))).On();
 ...
 */ class hi {
     ...
     */    delete() {
        return _i(this._o.delete());
    }
}

/** An error that wraps exceptions that thrown during IndexedDB execution. */ class ai extends O {
    constructor(t) {
 ...
 */ class ci {
    constructor(t) {
         ...
         */
        this.To = new Xn, this.transaction.oncomplete = () => {
            this.To.resolve();
        }, this.transaction.onabort = () => {
            t.error ? this.To.reject(new ai(t.error)) : this.To.resolve();
        }, this.transaction.onerror = t => {
            const e = di(t.target.error);
            this.To.reject(new ai(e));
        };
    }
    static open(t, e, n) {
        return new ci(t.transaction(n, e));
    }
    get lo() {
        return this.To.promise;
    }
    abort(t) {
        t && this.To.reject(t), this.aborted || (A("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
 ...
 */ class li {
     ...
     */    add(t) {
        return A("SimpleDb", "ADD", this.store.name, t, t), _i(this.store.add(t));
    }
    /**
     ...
     */    get(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
        return _i(this.store.get(t)).next(e => (
        // Normalize nonexistence to null.
        void 0 === e && (e = null), A("SimpleDb", "GET", this.store.name, t, e), e));
    }
    delete(t) {
        return A("SimpleDb", "DELETE", this.store.name, t), _i(this.store.delete(t));
    }
    /**
     ...
     */    count() {
        return A("SimpleDb", "COUNT", this.store.name), _i(this.store.count());
    }
    Ws(t, e) {
    ...
    Eo(t, e) {
        ...
        return new jn((s, i) => {
            t.onerror = t => {
                ...
                if (!i) return void s();
                const r = new hi(i), o = e(i.primaryKey, i.value, r);
                if (o instanceof jn) {
                    const t = o.catch(t => (r.done(), jn.reject(t)));
                    n.push(t);
                }
 ...
 * limitations under the License.
 */
/** The Platform's 'window' implementation or null if not available. */ function wi() {
...
class Ti {
    constructor(t, e, n, s, i) {
        this.mo = t, this.vs = e, this.Ao = n, this.op = s, this.Ro = i, this.Po = new Xn, 
     ...
     */    static Vo(t, e, n, s, i) {
        const r = Date.now() + n, o = new Ti(t, e, r, s, i);
        return o.start(n), o;
    }
    /**
     ...
     */    cancel(t) {
        null !== this.yo && (this.clearTimeout(), this.Po.reject(new O(M.CANCELLED, "Operation cancelled" + (t ? ": " + t : ""))));
    }
    po() {
...
class Ei {
    constructor() {
        ...
        this.$o = new Zn(this, "async_queue_retry" /* AsyncQueueRetry */), 
 ...
 // Failure will be handled by AsyncQueue
    ...
    Lo(t) {
        const e = this.bo.then(() => (this.Fo = !0, t().catch(t => {
            ...
            throw this.Co = t, this.Fo = !1, R("INTERNAL UNHANDLED ERROR: ", 
            /**
 ...
 */ (t)), t;
     ...
     */    Os(t, e, n) {
        ...
        const s = Ti.Vo(this, t, e, n, t => this.Qo(t));
 ...
 */ function Ii(t, e) {
    if (R("AsyncQueue", `${e}: ${t}`), ui(t)) return new O(M.UNAVAILABLE, `${e}: ${t}`);
    throw t;
}
 ...
 */ class Ai {
    constructor(t) {
        this.Ho = t, this.buffer = new _t(mi), this.Yo = 0;
    }
    Jo() {
        return ++this.Yo;
    }
...
class Pi {
    ...
    static oh(t) {
        return new Pi(t, Pi.hh, Pi.ah);
    }
}

Pi.uh = -1, Pi.lh = 1048576, Pi._h = 41943040, Pi.hh = 10, Pi.ah = 1e3, Pi.fh = new Pi(Pi._h, Pi.hh, Pi.ah), 
Pi.dh = new Pi(Pi.uh, 0, 0);
...
class Vi {
    ...
    start(t) {
        this.xr.params.sh !== Pi.uh && this.Eh(t);
    }
    stop() {
    ...
    Eh(t) {
        ...
        A("LruGarbageCollector", `Garbage collection scheduled in ${e}ms`), this.Th = this.mo.Os("lru_garbage_collection" /* LruGarbageCollection */ , e, async () => {
            this.Th = null, this.wh = !0;
            try {
                await t.Ih(this.xr);
            } catch (t) {
                ui(t) ? A("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", t) : await vi(t);
            }
            await this.Eh(t);
        });
    }
...
/** Implements the steps for LRU garbage collection. */ class gi {
    ...
    /** Returns the nth sequence number, counting in order from the smallest. */    Rh(t, e) {
        if (0 === e) return jn.resolve(Jn.ps);
        const n = new Ai(e);
    ...
    Ph(t, e) {
        return this.params.sh === Pi.uh ? (A("LruGarbageCollector", "Garbage collection skipped; disabled"), 
        jn.resolve(Ri)) : this.Kr(t).next(n => n < this.params.sh ? (A("LruGarbageCollector", `Garbage collection skipped; Cache size ${n} ` + `is lower than threshold ${this.params.sh}`), 
        Ri) : this.Vh(t, e));
    }
    Kr(t) {
        return this.mh.Kr(t);
    ...
    Vh(t, e) {
        ...
        e > this.params.rh ? (A("LruGarbageCollector", "Capping sequence numbers to collect down " + `to the maximum of ${this.params.rh} ` + `from ${e}`), 
...
class yi {
    ...
    t, e, n) {
        ...
        this.ph = new x(t => J(t), Z), 
        /**
         * The read time of the last entry processed by `getNewDocumentChanges()`.
         *
         * PORTING NOTE: This is only used for multi-tab synchronization.
         */
        this.bh = B.min(), this.ns = t.Dr(n), this.vh = t.Nr(), this.Ji = t.Fr(), this.Sh = new Hn(this.vh, this.ns, this.persistence.$r()), 
        this.gh.Dh(this.Sh);
    }
    start() {
    ...
    async Ch(t) {
        ...
        const s = await this.persistence.runTransaction("Handle user change", "readonly", s => {
            ...
            // MutationQueue.
            n = new Hn(this.vh, e, this.persistence.$r()), e.eo(s))).next(t => {
                const e = [], r = [];
    ...
    Oh(t) {
        return this.persistence.runTransaction("Reject batch", "readwrite-primary", e => {
            let n;
            return this.ns.Jr(e, t).next(t => (g(null !== t), n = t.keys(), this.ns.so(e, t))).next(() => this.ns.ro(e)).next(() => this.Sh.us(e, n));
        });
    }
    to() {
        ...
        return this.persistence.runTransaction("Apply remote event", "readwrite-primary", s => {
            ...
            t.Qt.forEach((t, i) => {
                ...
                // Update the resume token if the change includes one.
                    ...
                    yi.Bh(o, a, t) && r.push(this.Ji.yi(s, a));
                }
            });
            let o = wt(), h = Rt();
            ...
            r.push(i.getEntries(s, h).next(n => {
                t.jt.forEach((h, a) => {
                    ...
                    // cache.
                                        a instanceof Rn && a.version.isEqual(B.min()) ? (
            ...
            return jn.Bn(r).next(() => i.apply(s)).next(() => this.Sh.cs(s, o));
        }).then(t => (this.yh = n, t));
    }
    /**
    ...
    async Uh(t) {
        try {
            await this.persistence.runTransaction("notifyLocalViewChanges", "readwrite", e => jn.forEach(t, t => jn.forEach(t.ms, n => this.persistence.wi.Fi(e, t.targetId, n)).next(() => jn.forEach(t.As, n => this.persistence.wi.$i(e, t.targetId, n)))));
        } catch (t) {
            if (!ui(t)) throw t;
    ...
    jh(t) {
        return this.persistence.runTransaction("Allocate target", "readwrite", e => {
            ...
            n = s, jn.resolve(n)) : this.Ji.Ti(e).next(s => (n = new st(t, s, 0 /* Listen */ , e.Li), 
    ...
    Di(t, e) {
        ...
        return void 0 !== n ? jn.resolve(this.yh.get(n)) : this.Ji.Di(t, e);
    }
    async Kh(t, e) {
    ...
    Gh(t, e) {
        ...
        }).next(() => this.gh._s(i, t, e ? n : B.min(), e ? s : Rt())).next(t => ({
            documents: t,
            zh: s
        })));
    }
    Mh(t, e, n) {
        ...
        return i.forEach(i => {
            r = r.next(() => n.zn(t, i)).next(t => {
                let r = t;
                const o = e.Cn.get(i);
                g(null !== o), (!r || r.version.o(o) < 0) && (r = s.pn(i, r, e), r && 
...
class bi extends yi {
    ...
    Yh(t) {
        return this.persistence.runTransaction("Lookup mutation documents", "readonly", e => this.ns.Xr(e, t).next(t => t ? this.Sh.us(e, t) : jn.resolve(null)));
    }
    Jh(t) {
        this.ns.io(t);
    }
 ...
 */
async function vi(t) {
    if (t.code !== M.FAILED_PRECONDITION || t.message !== Gn) throw t;
 ...
 */ class Si {
    constructor() {
        ...
        this.Zh = new _t(Di.ta), 
        // A set of outstanding references to a document sorted by target id.
        this.ea = new _t(Di.na);
    }
     ...
     * removed.
     */    oa(t) {
        const e = new j(new U([])), n = new Di(e, t), s = new Di(e, t + 1), i = [];
    ...
    aa(t) {
        const e = new j(new U([])), n = new Di(e, t), s = new Di(e, t + 1);
        let i = Rt();
        return this.ea.vt([ n, s ], t => {
            i = i.add(t.key);
        }), i;
    ...
    Mi(t) {
        const e = new Di(t, 0), n = this.Zh.Dt(e);
...
class Di {
    ...
    /** Compare by key then by ID */    static ta(t, e) {
        return j.P(t.key, e.key) || v(t.ua, e.ua);
    }
    /** Compare by ID then by key */    static na(t, e) {
        return v(t.ua, e.ua) || j.P(t.key, e.key);
    }
}
 ...
 */ function Ci(t, e) {
    if (0 !== e.length) throw new O(M.INVALID_ARGUMENT, `Function ${t}() does not support arguments, ` + "but was called with " + Yi(e.length, "argument") + ".");
}
 ...
 */ function Fi(t, e, n) {
    if (e.length !== n) throw new O(M.INVALID_ARGUMENT, `Function ${t}() requires ` + Yi(n, "argument") + ", but was called with " + Yi(e.length, "argument") + ".");
}
 ...
 */ function Ni(t, e, n) {
    if (e.length < n) throw new O(M.INVALID_ARGUMENT, `Function ${t}() requires at least ` + Yi(n, "argument") + ", but was called with " + Yi(e.length, "argument") + ".");
}
 ...
 */ function $i(t, e, n, s) {
    if (e.length < n || e.length > s) throw new O(M.INVALID_ARGUMENT, `Function ${t}() requires between ${n} and ` + `${s} arguments, but was called with ` + Yi(e.length, "argument") + ".");
}
...
function Li(t, e, n, s, i) {
    void 0 !== s && function(t, e, n, s, i) {
        if (!(s instanceof Array)) throw new O(M.INVALID_ARGUMENT, `Function ${t}() requires its ${e} ` + `option to be an array, but it was: ${Wi(s)}`);
        for (let r = 0; r < s.length; ++r) if (!i(s[r])) throw new O(M.INVALID_ARGUMENT, `Function ${t}() requires all ${e} ` + `elements to be ${n}, but the value at index ${r} ` + `was: ${Wi(s[r])}`);
    }(t, e, n, s, i);
}
 ...
 */ function qi(t, e, n, s) {
    if (!e.some(t => t === s)) throw new O(M.INVALID_ARGUMENT, `Invalid value ${Wi(s)} provided to function ` + `${t}() for its ${Hi(n)} argument. Acceptable ` + `values: ${e.join(", ")}`);
    return s;
}

/** Helper to validate the type of a provided input. */ function Ui(t, e, n, s) {
    let i = !1;
...
function ji(t, e, n) {
    if (void 0 === n) throw new O(M.INVALID_ARGUMENT, `Function ${t}() requires a valid ${Hi(e)} ` + "argument, but it was undefined.");
}
 ...
 */ function Gi(t, e, n, s) {
    const i = Wi(s);
    return new O(M.INVALID_ARGUMENT, `Function ${t}() requires its ${Hi(n)} ` + `argument to be a ${e}, but it was: ${i}`);
}

function zi(t, e, n) {
    if (n <= 0) throw new O(M.INVALID_ARGUMENT, `Function ${t}() requires its ${Hi(e)} argument to be a positive number, but it was: ${n}.`);
}
 ...
 * limitations under the License.
 */
/** Helper function to assert Uint8Array is available at runtime. */ function Ji() {
 ...
 */ class Xi {
    ...
    static fromBase64String(t) {
        Fi("Blob.fromBase64String", arguments, 1), ki("Blob.fromBase64String", "string", 1, t);
        try {
            return new Xi(nt.fromBase64String(t));
        } catch (t) {
            throw new O(M.INVALID_ARGUMENT, "Failed to construct Blob from Base64 string: " + t);
        }
    }
    static fromUint8Array(t) {
        if (Fi("Blob.fromUint8Array", arguments, 1), Ji(), !(t instanceof Uint8Array)) throw Gi("Blob.fromUint8Array", "Uint8Array", 1, t);
        return new Xi(nt.fromUint8Array(t));
    }
    toBase64() {
        return Fi("Blob.toBase64", arguments, 0), this.ca.toBase64();
    }
    toUint8Array() {
        return Fi("Blob.toUint8Array", arguments, 0), Ji(), this.ca.toUint8Array();
    }
    toString() {
 ...
 */ class Zi {
    constructor(t) {
        !function(t, e, n, s) {
            if (!(e instanceof Array) || e.length < s) throw new O(M.INVALID_ARGUMENT, `Function ${t}() requires its ${n} argument to be an ` + "array with at least " + `${Yi(s, "element")}.`);
        }("FieldPath", t, "fieldNames", 1);
        for (let e = 0; e < t.length; ++e) if (ki("FieldPath", "string", e, t[e]), 0 === t[e].length) throw new O(M.INVALID_ARGUMENT, "Invalid field name at argument $(i + 1). Field names must not be empty.");
        this.la = new W(t);
    }
}
 ...
 */ class tr extends Zi {
    ...
    isEqual(t) {
        if (!(t instanceof tr)) throw Gi("isEqual", "FieldPath", 1, t);
...
class or extends nr {
    ...
    da(t) {
        const e = ir(this, t, 
        /*array=*/ !0), n = this.ma.map(t => gr(t, e)), s = new Ue(n);
...
class hr extends nr {
    ...
    da(t) {
        const e = ir(this, t, 
        /*array=*/ !0), n = this.ma.map(t => gr(t, e)), s = new We(n);
        return new Ye(t.path, s);
    }
    isEqual(t) {
        // TODO(mrschmidt): Implement isEquals
...
class ar extends nr {
    ...
    da(t) {
        const e = new Ke(t.serializer, oe(t.serializer, this.Aa));
...
/** The public FieldValue class of the lite API. */ class ur extends nr {
    constructor() {
        super();
    }
    static delete() {
        return Ci("FieldValue.delete", arguments), new cr(new sr("FieldValue.delete"));
    }
    static serverTimestamp() {
        return Ci("FieldValue.serverTimestamp", arguments), new cr(new rr("FieldValue.serverTimestamp"));
    }
    static arrayUnion(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return Ni("FieldValue.arrayUnion", arguments, 1), new cr(new or("FieldValue.arrayUnion", t));
    }
    static arrayRemove(...t) {
        // NOTE: We don't actually parse the data until it's used in set() or
        // update() since we'd need the Firestore instance to do this.
        return Ni("FieldValue.arrayRemove", arguments, 1), new cr(new hr("FieldValue.arrayRemove", t));
    }
    static increment(t) {
        return ki("FieldValue.increment", "number", 1, t), Fi("FieldValue.increment", arguments, 1), 
        new cr(new ar("FieldValue.increment", t));
    }
}
 ...
 */ class cr extends ur {
    ...
    isEqual(t) {
        return t instanceof cr && this._a.isEqual(t._a);
    }
}
 ...
 */ class lr {
    constructor(t, e) {
        if (Fi("GeoPoint", arguments, 2), ki("GeoPoint", "number", 1, t), ki("GeoPoint", "number", 2, e), 
     ...
     * with an underscore.
     */    T(t) {
        return v(this.Ra, t.Ra) || v(this.Pa, t.Pa);
    }
}
...
/** The result of parsing document data (e.g. for a setData call). */ class wr {
    constructor(t, e, n) {
...
/** The result of parsing "update" data (i.e. for an updateData call). */ class Tr {
    constructor(t, e, n) {
        this.data = t, this.Le = e, this.fieldTransforms = n;
    }
    pa(t, e) {
...
/** A "context" object passed around while parsing user data. */ class Ir {
    /**
    ...
    /** Returns a new context with the specified settings overwritten. */    va(t) {
        return new Ir(Object.assign(Object.assign({}, this.settings), t), this.s, this.serializer, this.ignoreUndefinedProperties, this.fieldTransforms, this.Le);
    }
    Sa(t) {
        var e;
    ...
    Ta(t) {
        return Dr(t, this.settings.methodName, this.settings.Na || !1, this.path, this.settings.Ea);
    }
    ...
    Da(t) {
        ...
        if (Er(this.wa) && fr.test(t)) throw this.Ta('Document fields cannot begin and end with "__"');
    }
}
 ...
 */ class mr {
    constructor(t, e, n) {
        this.s = t, this.ignoreUndefinedProperties = e, this.serializer = n || _r(t);
    }
...
/** Parse document data from a set() call. */ function Ar(t, e, n, s, i, r = {}) {
    const o = t.$a(r.merge || r.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    br("Data must be an object, but it was:", o, s);
    const h = yr(s, o);
    let a, u;
    if (r.merge) a = new He(o.Le), u = o.fieldTransforms; else if (r.mergeFields) {
        ...
        for (const s of r.mergeFields) {
            let i;
            if (s instanceof Zi) i = s.la; else {
    ...
    return new wr(new Tn(h), a, u);
}

/** Parse update data from an update() call. */ function Rr(t, e, n, s) {
    const i = t.$a(1 /* Update */ , e, n);
    br("Data must be an object, but it was:", i, s);
    const r = [], o = new En;
    $(s, (t, s) => {
        const h = Sr(e, t, n), a = i.Ca(h);
        if (s instanceof nr && s._a instanceof sr) 
    ...
    const h = new He(r);
    return new Tr(o.ze(), h, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Pr(t, e, n, s, i, r) {
    const o = t.$a(1 /* Update */ , e, n), h = [ vr(e, s, n) ], a = [ i ];
    ...
    for (let t = 0; t < r.length; t += 2) h.push(vr(e, r[t])), a.push(r[t + 1]);
    const u = [], c = new En;
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (let t = h.length - 1; t >= 0; --t) if (!Cr(u, h[t])) {
        const e = h[t], n = a[t], s = o.Ca(e);
        if (n instanceof nr && n._a instanceof sr) 
        // Add it to the field mask, but don't add anything to updateData.
        u.push(e); else {
            const t = gr(n, s);
    ...
    const l = new He(u);
    return new Tr(c.ze(), l, o.fieldTransforms);
}
 ...
 */ function Vr(t, e, n, s = !1) {
    return gr(n, t.$a(s ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function gr(t, e) {
    if (pr(t)) return br("Unsupported field value:", e, t), yr(t, e);
    if (t instanceof nr) 
 ...
 */
    return function(t, e) {
        ...
        if (!Er(e.wa)) throw e.Ta(`${t.fa}() can only be used with update() and set()`);
 ...
 */ (t, e), null;
    ...
    return function(t, e) {
        ...
        if (t instanceof dr) {
            ...
            return {
                referenceValue: le(t.Va || e.s, t.ga.path)
            };
        }
        if (void 0 === t && e.ignoreUndefinedProperties) return null;
        throw e.Ta(`Unsupported field value: ${Wi(t)}`);
    }
    /**
...
function pr(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof L || t instanceof lr || t instanceof Xi || t instanceof dr || t instanceof nr);
}
 ...
 */ function vr(t, e, n) {
    if (e instanceof Zi) return e.la;
    if ("string" == typeof e) return Sr(t, e);
    throw Dr("Field path arguments must be of type string or FieldPath.", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 */ function Sr(t, e, n) {
    try {
        return function(t) {
            if (t.search(er) >= 0) throw new O(M.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not contain ` + "'~', '*', '/', '[', or ']'");
            try {
                return new tr(...t.split("."));
            } catch (e) {
                throw new O(M.INVALID_ARGUMENT, `Invalid field path (${t}). Paths must not be empty, ` + "begin with '.', end with '.', or contain '..'");
            }
        }(e).la;
    } catch (e) {
        throw Dr((s = e) instanceof Error ? s.message : s.toString(), t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, n);
    }
    /**
...
Fr.xa = new Fr("google-credentials-uid"), Fr.Ma = new Fr("first-party-uid");
...
class kr {
    constructor(t) {
        ...
        this.currentUser = Fr.UNAUTHENTICATED, this.Wa = !1, 
        /**
    ...
    getToken() {
        ...
        this.ja !== t ? (A("FirebaseCredentialsProvider", "getToken aborted due to token change."), 
        this.getToken()) : e ? (g("string" == typeof e.accessToken), new Nr(e.accessToken, this.currentUser)) : null) : Promise.resolve(null);
    }
    Ba() {
        this.forceRefresh = !0;
    }
 ...
 */ class xr {
    constructor(t, e) {
        this.Ga = t, this.za = e, this.type = "FirstParty", this.user = Fr.Ma;
    }
    get Oa() {
        const t = {
 ...
 */ class Mr {
    ...
    getToken() {
        return Promise.resolve(new xr(this.Ga, this.za));
    }
    qa(t) {
...
class Or {
    constructor(t, e, n, s, i, r) {
         ...
         * close.
         */
        this.Za = 0, this.tu = null, this.stream = null, this.$o = new Zn(t, e);
    }
    /**
     ...
     */    lu(t) {
        return e => {
            this.bs.cr(() => this.Za === t ? e() : (A("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
            Promise.resolve()));
        };
    }
}
 ...
 */ class Lr extends Or {
    ...
    onMessage(t) {
        ...
        const e = Re(this.serializer, t), n = function(t) {
            ...
            return e.targetIds && e.targetIds.length ? B.min() : e.readTime ? ce(e.readTime) : B.min();
        }(t);
     ...
     */    mu(t) {
        const e = {};
        e.database = Ee(this.serializer), e.removeTarget = t, this.hu(e);
    }
}
 ...
 */ class Br extends Or {
    ...
    onMessage(t) {
        ...
        g(!!t.streamToken), this.lastStreamToken = t.streamToken, this.Au) {
            // A successful first write response means the stream is healthy,
            // Note, that we could consider a successful handshake healthy, however,
            // the write itself might be causing an error we want to back off from.
            this.$o.reset();
            const e = ge(t.writeResults, t.commitTime), n = ce(t.commitTime);
            return this.listener.Vu(n, e);
        }
        // The first response is always the handshake response
        return g(!t.writeResults || 0 === t.writeResults.length), this.Au = !0, this.listener.gu();
    }
    /**
     ...
     */    yu() {
        ...
        const t = {};
        t.database = Ee(this.serializer), this.hu(t);
    }
...
class qr extends class {
    ...
    bu() {
        if (this.pu) throw new O(M.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    /** Gets an auth token and invokes the provided RPC. */    vu(t, e) {
        return this.bu(), this.credentials.getToken().then(n => this.Ja.vu(t, e, n)).catch(t => {
            throw t.code === M.UNAUTHENTICATED && this.credentials.Ba(), t;
        });
    }
...
class Ur {
    ...
    async ku(t) {
        if (this.xu(), this.mutations.length > 0) throw new O(M.INVALID_ARGUMENT, "Firestore transactions require all reads to be executed before all writes.");
        const e = await async function(t, e) {
            const n = y(t), s = {
                database: Ee(n.serializer),
        ...
        return e.forEach(t => {
            t instanceof Rn || t instanceof An ? this.Mu(t) : V();
        }), e;
    }
    set(t, e) {
    ...
    delete(t) {
        this.write([ new dn(t, this.Ue(t)) ]), this.$u.add(t);
    }
    async commit() {
     ...
     */    Ue(t) {
        ...
        return !this.$u.has(t) && e ? Ze.updateTime(e) : Ze.Qe();
    }
    /**
...
class Wr {
    ...
    e, n, s, i) {
        ...
        this.Xu = new Set, this.Zu = i, this.Zu.tc(t => {
            n.cr(async () => {
                ...
                // down our streams.
                this.ec() && (A("RemoteStore", "Restarting streams for network reachability change."), 
                await this.nc());
            });
        }), this.sc = new Qr(n, s), 
        ...
        this.ic = function(t, e, n) {
            ...
            const s = y(t);
            return new Br(e, s.Ja, s.credentials, s.serializer, n);
        }(this.Du, n, {
    ...
    async Tc() {
        await this.ac.stop(), await this.ic.stop(), this.Hu.length > 0 && (A("RemoteStore", `Stopping write stream with ${this.Hu.length} pending writes`), 
        this.Hu = []), this.Ec();
    }
    async gr() {
        A("RemoteStore", "RemoteStore shutting down."), this.Xu.add(5 /* Shutdown */), await this.Tc(), 
        this.Zu.gr(), 
    ...
    dc() {
        this.Ju = new Nt(this), this.ic.start(), this.sc.Qu();
    }
    /**
    ...
    async hc(t, e) {
        ...
        this.sc.set("Online" /* Online */), t instanceof Ct && 2 /* Removed */ === t.state && t.cause) 
        ...
        try {
            ...
            await this.Vc(e);
        } else if (t instanceof St ? this.Ju.Pe(t) : t instanceof Dt ? this.Ju.De(t) : this.Ju.ye(t), 
        !e.isEqual(B.min())) try {
            ...
            A("RemoteStore", "Failed to raise snapshot:", t), await this.Vc(t);
        }
    }
    /**
     ...
     */    async Vc(t, e) {
        ...
        this.mo._r(async () => {
            A("RemoteStore", "Retrying IndexedDB access"), await e(), this.Xu.delete(1 /* IndexedDbFailed */), 
            await this._c();
        });
    }
    /**
    ...
    async Vu(t, e) {
        const n = this.Hu.shift(), s = Wn.from(n, t, e);
 ...
 */    }
    ...
    async xc(t) {
        ...
        A("RemoteStore", "RemoteStore received new credentials"), this.Xu.add(3 /* CredentialChange */), 
...
class zr {
     ...
     */    static Oc(t, e, n) {
        ...
        i && (r = new O(s.error.code, s.error.message))), i ? new zr(t, e, s.state, r) : (R("SharedClientState", `Failed to parse mutation state for ID '${e}': ${n}`), 
        null);
    }
    Lc() {
        const t = {
...
class Hr {
     ...
     */    static Oc(t, e) {
        ...
        s && (i = new O(n.error.code, n.error.message))), s ? new Hr(t, n.state, i) : (R("SharedClientState", `Failed to parse target state for ID '${t}': ${e}`), 
        null);
    }
    Lc() {
        const t = {
 ...
 */ class Yr {
     ...
     */    static Oc(t, e) {
        ...
        return s ? new Yr(t, i) : (R("SharedClientState", `Failed to parse client data for instance '${t}': ${e}`), 
        null);
    }
}
 ...
 */ class Jr {
     ...
     */    static Oc(t) {
        ...
        return "object" == typeof e && -1 !== [ "Unknown", "Online", "Offline" ].indexOf(e.onlineState) && "string" == typeof e.clientId ? new Jr(e.clientId, e.onlineState) : (R("SharedClientState", `Failed to parse online state: ${t}`), 
        null);
    }
}
 ...
 */ class Zr {
    constructor(t, e, n, s, i) {
        ...
        this.Lu = null, this.Ps = null, this.Qc = this.Wc.bind(this), this.jc = new ut(v), 
        this.or = !1, 
        /**
        ...
        const r = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.Gc = jr(this.persistenceKey, this.Uc), 
        this.zc = 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ (this.persistenceKey), this.jc = this.jc.nt(this.Uc, new Xr), this.Hc = new RegExp(`^firestore_clients_${r}_([^_]*)$`), 
    ...
    Wc(t) {
        ...
        if (e.storageArea === this.storage) {
            if (A("SharedClientState", "EVENT", e.key, e.newValue), e.key === this.Gc) return void R("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.bs._r(async () => {
                if (this.or) {
 ...
 */ (e.newValue);
    ...
    ol(t, e, n) {
        const s = new zr(this.currentUser, t, e, n), i = Kr(this.persistenceKey, this.currentUser, t);
        this.setItem(i, s.Lc());
    }
    al(t) {
    ...
    wl(t, e, n) {
        const s = Gr(this.persistenceKey, t), i = new Hr(t, e, n);
        this.setItem(s, i.Lc());
    }
    /**
...
class to {
    constructor() {
        this.vl = new Xr, this.Sl = {}, this.Rc = null, this.Lu = null, this.Ps = null;
    }
    rl(t) {
        // No op.
    }
    ...
    start() {
        return this.vl = new Xr, Promise.resolve();
    }
    Ch(t, e, n) {
        // No op.
    }
 ...
 */ class so {
    ...
    e) {
        ...
        this.Lt = Rt(), this.Nl = vn(t), this.$l = new gt(this.Nl);
    }
    /**
     ...
     */    xl(t, e) {
        const n = e ? e.Ml : new yt, s = e ? e.$l : this.$l;
 ...
 */ (t.type, e.type) || this.Nl(t.doc, e.doc)), this.Bl(n);
        ...
        if (this.Cl = o, 0 !== i.length || h) {
            return {
                snapshot: new pt(this.query, t.$l, s, i, t.Lt, 0 /* Local */ === o, h, 
                /* excludesMetadataChanges= */ !1),
                Ul: r
            };
        }
    ...
    ql() {
        ...
        // updating many documents.
                const t = this.Fl;
        this.Fl = Rt(), this.$l.forEach(t => {
            this.Wl(t.key) && (this.Fl = this.Fl.add(t.key));
        });
        // Diff the new limbo docs with the old limbo docs.
        const e = [];
        return t.forEach(t => {
            this.Fl.has(t) || e.push(new no(t));
        }), this.Fl.forEach(n => {
            t.has(n) || e.push(new eo(n));
        }), e;
    }
    /**
    ...
    // PORTING NOTE: Multi-tab only.
    Kl() {
        return pt.Ut(this.query, this.$l, this.Lt, 0 /* Local */ === this.Cl);
    }
}
...
class io {
    constructor(t, e, n, s) {
        this.mo = t, this.Du = e, this.updateFunction = n, this.Po = s, this.Gl = 5, this.$o = new Zn(this.mo, "transaction_retry" /* TransactionRetry */);
    }
    ...
    zl() {
        this.$o.xs(async () => {
            const t = new Ur(this.Du), e = this.Hl(t);
            e && e.then(e => {
    ...
    Hl(t) {
        try {
            ...
            return !K(e) && e.catch && e.then ? e : (this.Po.reject(Error("Transaction callback must return a Promise")), 
            null);
        } catch (t) {
 ...
 */ class ho {
    ...
    s, i, r) {
        ...
        this.n_ = null, this.s_ = new x(t => yn(t), gn), this.i_ = new Map, 
        /**
         ...
         */
        this.h_ = new Map, this.a_ = new Si, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.u_ = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.c_ = new Map, this.l_ = Vs.di(), this.onlineState = "Unknown" /* Unknown */;
    }
    get __() {
        return !0;
    }
     ...
     */    async d_(t, e, n) {
        ...
        /* usePreviousResults= */ !0), i = new so(t, s.zh), r = i.xl(s.documents), o = vt.zt(e, n && "Offline" /* Offline */ !== this.onlineState), h = i.Jn(r, 
        /* updateLimboDocuments= */ this.__, o);
        this.w_(e, h.Ul);
        const a = new ro(t, e, i);
    ...
    async mc(t) {
        ...
        // to the target.
                if (n.length > 1) return this.i_.set(e.targetId, n.filter(e => !gn(e, t))), 
    ...
    async write(t, e) {
        ...
        try {
            ...
            const n = Ii(t, "Failed to persist write");
            e.reject(n);
        }
    }
    runTransaction(t, e, n) {
        new io(t, this.Du, e, n).run();
    }
    async Lh(t) {
        ...
        try {
            ...
            // Update `receivedDocument` as appropriate for any limbo targets.
                ...
                g(t.Yt.size + t.Jt.size + t.Xt.size <= 1), t.Yt.size > 0 ? n.Xl = !0 : t.Jt.size > 0 ? g(n.Xl) : t.Xt.size > 0 && (g(n.Xl), 
                n.Xl = !1));
            }), await this.I_(e, t);
        } catch (t) {
            await vi(t);
    ...
    async pc(t, e) {
        ...
        if (s) {
            ...
            let e = new ut(j.P);
            e = e.nt(s, new Rn(s, B.min()));
            const n = Rt().add(s), i = new bt(B.min(), 
        ...
        } else await this.zu.Kh(t, /* keepPersistedTargetData */ !1).then(() => this.T_(t, e)).catch(vi);
    }
    async Fc(t) {
    ...
    async V_(t) {
        this.Zl.ec() || A("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled.");
        try {
            ...
            const n = Ii(e, "Initialization of waitForPendingWrites() operation failed");
            t.reject(n);
        }
    }
    /**
    ...
    E_(t, e) {
        ...
        n || (n = new ut(v)), n = n.nt(t, e), this.u_[this.currentUser.ka()] = n;
    }
    /**
    ...
    w_(t, e) {
        for (const n of e) if (n instanceof eo) this.a_.Fi(n.key, t), this.b_(n); else if (n instanceof no) {
            A("SyncEngine", "Document no longer in limbo: " + n.key), this.a_.$i(n.key, t), 
            this.a_.Mi(n.key) || 
            // We removed the last reference for this key
            this.p_(n.key);
        } else V();
    ...
    b_(t) {
        const e = t.key;
        this.o_.get(e) || (A("SyncEngine", "New document in limbo: " + e), this.r_.push(e), 
        this.A_());
    }
    /**
     ...
     */    A_() {
        for (;this.r_.length > 0 && this.o_.size < this.e_; ) {
            ...
            this.h_.set(e, new oo(t)), this.o_ = this.o_.nt(t, e), this.Zl.listen(new st(Vn.hn(t.path).We(), e, 2 /* LimboResolution */ , Jn.ps));
        }
    }
    // Visible for testing
    v_() {
        ...
        this.s_.forEach((r, o) => {
            i.push(Promise.resolve().then(() => {
                ...
                if (this.w_(o.targetId, r.Ul), r.snapshot) {
                    ...
                    n.push(r.snapshot);
                    const t = Yn.Rs(o.targetId, r.snapshot);
                    s.push(t);
                }
            }));
    ...
    async xc(t) {
        if (!this.currentUser.isEqual(t)) {
            A("SyncEngine", "User change. New user:", t.ka());
 ...
 */ class uo extends ho {
    ...
    async yl(t, e, n) {
        ...
        // other clients.
        this.R_(t, n || null), this.zu.Jh(t)) : V(), await this.I_(s)) : 
        ...
        // as applicable.
        A("SyncEngine", "Cannot apply mutation batch with id: " + t);
    }
    async Mc(t) {
        if (!0 === t && !0 !== this.D_) {
    ...
    N_() {
        this.h_.forEach((t, e) => {
            this.Zl.mc(e);
        }), this.a_.ha(), this.h_ = new Map, this.o_ = new ut(j.P);
    }
    /**
    ...
    async pl(t, e, n) {
        ...
        A("SyncEngine", "Ignoring unexpected query state notification."); else if (this.i_.has(t)) switch (e) {
          case "current":
          case "not-current":
            {
                const n = await this.zu.si(), s = bt.Gt(t, "current" === e);
                await this.I_(n, s);
                break;
            }
        ...
        if (this.D_) {
            for (const e of t) {
                if (this.i_.has(e)) {
                    ...
                    A("SyncEngine", "Adding an already active target " + e);
                    continue;
                }
 ...
 */ class lo {
    constructor(t) {
        this.Rc = t, this.M_ = new x(t => yn(t), gn), this.onlineState = "Unknown" /* Unknown */ , 
        this.O_ = new Set, this.Rc.subscribe(this);
    }
    async listen(t) {
        const e = t.query;
        let n = !1, s = this.M_.get(e);
        if (s || (n = !0, s = new co), n) try {
            s.x_ = await this.Rc.listen(e);
        } catch (e) {
            const n = Ii(e, `Initialization of query '${pn(t.query)}' failed`);
 ...
 */ class _o {
     ...
     */    L_(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new pt(t.query, t.docs, t.Ot, e, t.Lt, t.fromCache, t.Bt, 
    ...
    z_(t) {
        t = pt.Ut(t.query, t.docs, t.Lt, t.fromCache), this.W_ = !0, this.Q_.next(t);
    }
}
 ...
 */ class fo {
    ...
    _s(t, e, s, i) {
        ...
        return e.En() || s.isEqual(B.min()) ? this.J_(t, e) : this.Y_.us(t, i).next(r => {
            const o = this.X_(e, r);
            return (e.In() || e.mn()) && this.Ll(e.nn, o, i, s) ? this.J_(t, e) : (m() <= n.DEBUG && A("IndexFreeQueryEngine", "Re-using previous result from %s to execute query: %s", s.toString(), pn(e)), 
    ...
    /** Applies the query filter and sorting to the provided documents.  */    X_(t, e) {
        ...
        let n = new _t(vn(t));
        return e.forEach((e, s) => {
            s instanceof An && bn(t, s) && (n = n.add(s));
        }), n;
    }
    /**
    ...
    J_(t, e) {
        return m() <= n.DEBUG && A("IndexFreeQueryEngine", "Using full collection scan to execute query:", pn(e)), 
 ...
 */ class wo {
    constructor(t, e) {
        ...
        this.tf = new _t(Di.ta);
    }
    Hr(t) {
        return jn.resolve(0 === this.ns.length);
    }
    Yr(t, e, n, s) {
        const i = this.Z_;
        ...
        for (const e of s) this.tf = this.tf.add(new Di(e.key, i)), this.ss.Us(t, e.key.path.p());
        return jn.resolve(r);
    }
    Jr(t, e) {
        return jn.resolve(this.ef(e));
    }
    Zr(t, e) {
        const n = e + 1, s = this.nf(n), i = s < 0 ? 0 : s;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return jn.resolve(this.ns.length > i ? this.ns[i] : null);
    }
    to() {
        return jn.resolve(0 === this.ns.length ? -1 : this.Z_ - 1);
    }
    eo(t) {
        return jn.resolve(this.ns.slice());
    }
    os(t, e) {
        const n = new Di(e, 0), s = new Di(e, Number.POSITIVE_INFINITY), i = [];
    ...
    ls(t, e) {
        let n = new _t(v);
        return e.forEach(t => {
            const e = new Di(t, 0), s = new Di(t, Number.POSITIVE_INFINITY);
            this.tf.vt([ e, s ], t => {
                n = n.add(t.ua);
            });
        }), jn.resolve(this.sf(n));
    }
    Es(t, e) {
    ...
    so(t, e) {
        g(0 === this.if(e.batchId, "removed")), this.ns.shift();
        let n = this.tf;
        return jn.forEach(e.mutations, s => {
            const i = new Di(s.key, e.batchId);
    ...
    Mi(t, e) {
        const n = new Di(e, 0), s = this.tf.Dt(n);
        return jn.resolve(e.isEqual(s && s.key));
    }
    ro(t) {
        return this.ns.length, jn.resolve();
    }
    /**
 ...
 */ class To {
    ...
    _s(t, e, n) {
        ...
        for (;r.wt(); ) {
            ...
            o.o(n) <= 0 || i instanceof An && bn(e, i) && (s = s.nt(i.key, i));
        }
        return jn.resolve(s);
    }
    hf(t, e) {
        return jn.forEach(this.docs, t => e(t));
    }
    oi(t) {
        // `trackRemovals` is ignores since the MemoryRemoteDocumentCache keeps
        // a separate changelog and does not need special handling for removals.
        return new To.hi(this);
    }
    ui(t) {
...
class Eo {
    constructor(t) {
         ...
         * IDs.
         */
        this.cf = new Si, this.targetCount = 0, this.lf = Vs.fi();
    }
    pe(t, e) {
        return this.af.forEach((t, n) => e(n)), jn.resolve();
    }
    mi(t) {
        return jn.resolve(this.lastRemoteSnapshotVersion);
    }
    Ai(t) {
        return jn.resolve(this.uf);
    }
    Ti(t) {
        return this.highestTargetId = this.lf.next(), jn.resolve(this.highestTargetId);
    }
    Ri(t, e, n) {
    ...
    Vi(t) {
        ...
        const e = t.targetId;
        e > this.highestTargetId && (this.lf = new Vs(e), this.highestTargetId = e), t.sequenceNumber > this.uf && (this.uf = t.sequenceNumber);
    }
    Pi(t, e) {
        return this.Vi(e), this.targetCount += 1, jn.resolve();
    }
    yi(t, e) {
        return this.Vi(e), jn.resolve();
    }
    pi(t, e) {
    ...
    Ci(t, e, n) {
        return this.cf.sa(e, n), jn.resolve();
    }
    Ni(t, e, n) {
        this.cf.ra(e, n);
    ...
    bi(t, e) {
        return this.cf.oa(e), jn.resolve();
    }
    ki(t, e) {
    ...
    Mi(t, e) {
        return jn.resolve(this.cf.Mi(e));
    }
}
...
class Io {
     ...
     */
    constructor(t) {
        this._f = {}, this.Ui = new Jn(0), this.Qi = !1, this.Qi = !0, this.wi = t(this), 
        this.Ji = new Eo(this);
        this.ss = new is, this.es = new To(this.ss, t => this.wi.ff(t));
    }
    start() {
        return Promise.resolve();
    }
    ...
    Dr(t) {
        let e = this._f[t.ka()];
        return e || (e = new wo(this.ss, this.wi), this._f[t.ka()] = e), e;
    }
    Fr() {
        return this.Ji;
    }
    ...
    runTransaction(t, e, n) {
        ...
        const s = new mo(this.Ui.next());
        return this.wi.df(), n(s).next(t => this.wi.wf(s).next(() => t)).On().then(t => (s.ts(), 
        t));
    }
    Tf(t, e) {
        return jn.qn(Object.values(this._f).map(n => () => n.Mi(t, e)));
    }
}
...
class Ao {
    ...
    Fi(t, e, n) {
        return this.Ef.Fi(n, e), this.Af.delete(n), jn.resolve();
    }
    $i(t, e, n) {
        return this.Ef.$i(n, e), this.Af.add(n), jn.resolve();
    }
    qr(t, e) {
        return this.Af.add(e), jn.resolve();
    }
    removeTarget(t, e) {
    ...
    wf(t) {
        ...
        return jn.forEach(this.Af, n => this.Rf(t, n).next(t => {
            t || e.Gn(n);
    ...
    Rf(t, e) {
        return jn.qn([ () => jn.resolve(this.Ef.Mi(e)), () => this.persistence.Fr().Mi(t, e), () => this.persistence.Tf(t, e) ]);
    }
}
...
class go {
            ...
            o.listenOnce(_.COMPLETE, () => {
                try {
                    switch (o.getLastErrorCode()) {
                      ...
                      case f.TIMEOUT:
                        A("Connection", 'RPC "' + t + '" timed out'), r(new O(M.DEADLINE_EXCEEDED, "Request time out"));
                        break;
                      ...
                      case f.HTTP_ERROR:
                        ...
                        A("Connection", 'RPC "' + t + '" failed'), r(new O(M.UNAVAILABLE, "Connection failed."));
                        break;
    ...
    Tu(t, e) {
        const s = [ this.Df, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = d(), l = {
        ...
        r() || o() || h() || a() || u() || c() || (l.httpHeadersOverwriteParam = "$httpHeaders");
        const _ = s.join("");
        A("Connection", "Creating WebChannel: " + _ + " " + l);
        const f = i.createWebChannel(_, l);
        ...
        // on a closed stream
                const R = new Ro({
            Pf: t => {
                m ? A("Connection", "Not sending because WebChannel is closed:", t) : (T || (A("Connection", "Opening WebChannel transport."), 
                f.open(), T = !0), A("Connection", "WebChannel sending:", t), f.send(t));
            },
            Vf: () => f.close()
        }), V = (t, e) => {
        ...
        // enough the code is exception free.
                return V(w.EventType.OPEN, () => {
            m || A("Connection", "WebChannel transport opened.");
        }), V(w.EventType.CLOSE, () => {
            m || (m = !0, A("Connection", "WebChannel transport closed"), R.vf());
        }), V(w.EventType.ERROR, t => {
            m || (m = !0, function(t, ...e) {
                if (I.logLevel <= n.WARN) {
                    const n = e.map(P);
                    I.warn(`Firestore (${E}): ${t}`, ...n);
                }
            }("Connection", "WebChannel transport errored:", t), R.vf(new O(M.UNAVAILABLE, "The operation could not be completed")));
        }), V(w.EventType.MESSAGE, t => {
            var e;
            if (!m) {
                const n = t.data[0];
                g(!!n);
                ...
                if (i) {
                    ...
                    m = !0, R.vf(new O(e, n)), f.close();
                } else A("Connection", "WebChannel received:", n), R.Sf(n);
            }
        }), setTimeout(() => {
 ...
 * limitations under the License.
 */
const bo = "You are using the memory-only build of Firestore. Persistence support is only available via the @firebase/firestore bundle or the firebase-firestore.js build.";
 ...
 */ class vo {
    ...
    Gf(t) {
        return new lo(this.Rc);
    }
    Uf(t) {
        return null;
    }
    Qf(t) {
        return pi(this.persistence, new fo, t.zf);
    }
    Bf(t) {
        if (t.Yf.Hf) throw new O(M.FAILED_PRECONDITION, bo);
        return new Io(Ao.mf);
    }
    Wf(t) {
        return new Wr(this.zu, t.Du, t.mo, t => this.Rc.Ql(t, 0 /* RemoteStore */), yo.Hi() ? new yo : new po);
    }
    Lf(t) {
        return new to;
    }
    jf(t) {
        return ao(this.zu, this.Zl, t.Du, this.t_, t.zf, t.e_);
    }
    clearPersistence(t, e) {
        throw new O(M.FAILED_PRECONDITION, bo);
    }
}
 ...
 */ class So extends vo {
    ...
    Bf(t) {
        const e = ks(t.Jf.s, t.Jf.persistenceKey), n = _r(t.Jf.s);
        return new Ds(t.Yf.synchronizeTabs, e, t.clientId, Pi.oh(t.Yf.cacheSizeBytes), t.mo, wi(), "undefined" != typeof document ? document : null, n, this.t_, t.Yf.qi);
    }
    Lf(t) {
        return new to;
    }
    clearPersistence(t, e) {
        return async function(t) {
            if (!oi.Hi()) return Promise.resolve();
            const e = t + "main";
            await oi.delete(e);
        }(ks(t, e));
    }
 ...
 */ class Do extends So {
    ...
    Qf(t) {
        /** Manages our in-memory or durable persistence. */
        return e = this.persistence, n = new fo, s = t.zf, new bi(e, n, s);
        var e, n, s;
    }
    jf(t) {
        ...
        new uo(n, s, i, r, o, h));
        var n, s, i, r, o, h;
        return this.t_ instanceof Zr && (this.t_.Rc = e), e;
    }
    Lf(t) {
        if (t.Yf.Hf && t.Yf.synchronizeTabs) {
            const e = wi();
            if (!Zr.Hi(e)) throw new O(M.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
            const n = ks(t.Jf.s, t.Jf.persistenceKey);
            return new Zr(e, t.mo, n, t.clientId, t.zf);
        }
        return new to;
    }
}
...
class Co {
     ...
     */
    e) {
        this.credentials = t, this.mo = e, this.clientId = b.t();
    }
    /**
     ...
     */    start(t, e, n) {
        ...
        return this.credentials.qa(t => {
            if (!r) return r = !0, A("FirestoreClient", "Initializing. user=", t.uid), this.Xf(e, n, t, i).then(s.resolve, s.reject);
     ...
     */    async Xf(t, e, n, s) {
        try {
            ...
            // provider).
            const r = await (i = this.Jf, Promise.resolve(new go(i))), o = _r(this.Jf.s), h = function(t, e, n) {
                return new qr(t, e, n);
     ...
     */    bu() {
        if (this.mo.xo) throw new O(M.FAILED_PRECONDITION, "The client has already been terminated.");
    }
    ...
    async nd(t) {
        ...
        return await this.mo.enqueue(async () => {
            try {
                ...
                n instanceof An ? e.resolve(n) : n instanceof Rn ? e.resolve(null) : e.reject(new O(M.UNAVAILABLE, "Failed to get document from cache. (However, this document may exist on the server. Run again without setting 'source' in the GetOptions to attempt to retrieve the document from the server.)"));
            } catch (n) {
                const s = Ii(n, `Failed to get document '${t} from cache`);
                e.reject(s);
            }
        }), e.promise;
    }
    async sd(t) {
        ...
        return await this.mo.enqueue(async () => {
            try {
                ...
                /* usePreviousResults= */ !0), s = new so(t, n.zh), i = s.xl(n.documents), r = s.Jn(i, 
                /* updateLimboDocuments= */ !1);
                e.resolve(r.snapshot);
            } catch (n) {
                const s = Ii(n, `Failed to execute query '${t} against cache`);
                e.reject(s);
            }
        }), e.promise;
    }
...
class $o {
    ...
    dd(t) {
        return new lr(Gt(t.latitude), Gt(t.longitude));
    }
    wd(t) {
    ...
    fd(t) {
        const e = U.$(t);
        g(xe(e));
        const n = new F(e.get(1), e.get(3)), s = new j(e.g(5));
...
class xo {
    constructor(t) {
        ...
        } else Mi("settings", "non-empty string", "host", t.host), this.host = t.host, Oi("settings", "boolean", "ssl", t.ssl), 
        ...
        Oi("settings", "number", "cacheSizeBytes", t.cacheSizeBytes), void 0 === t.cacheSizeBytes) this.cacheSizeBytes = Pi._h; else {
            if (t.cacheSizeBytes !== ko && t.cacheSizeBytes < Pi.lh) throw new O(M.INVALID_ARGUMENT, `cacheSizeBytes must be at least ${Pi.lh}`);
 ...
 */ class Mo {
    ...
    constructor(t, e, n = new vo) {
        if (this.Ed = null, 
        // Public for use in tests.
        // TODO(mikelehen): Use modularized initialization instead.
        this.Id = new Ei, this.INTERNAL = {
            delete: async () => {
            ...
            const n = t;
            this.Ed = n, this.Va = Mo.Rd(n), this.Pd = n.name, this.Vd = new kr(e);
        } else {
            const e = t;
            if (!e.projectId) throw new O(M.INVALID_ARGUMENT, "Must provide projectId");
            this.Va = new F(e.projectId, e.database), 
            // Use a default persistenceKey that lines up with FirebaseApp.
            this.Pd = "[DEFAULT]", this.Vd = new $r;
        }
        this.gd = n, this.yd = new xo({});
    }
    get pd() {
        return this.bd || (
        // Lazy initialize UserDataReader once the settings are frozen
        this.bd = new mr(this.Va, this.yd.ignoreUndefinedProperties)), this.bd;
    }
    settings(t) {
        Fi("Firestore.settings", arguments, 1), ki("Firestore.settings", "object", 1, t);
        const e = new xo(t);
        if (this.Ad && !this.yd.isEqual(e)) throw new O(M.FAILED_PRECONDITION, "Firestore has already been started and its settings can no longer be changed. You can only call settings() before calling any other methods on a Firestore object.");
 ...
 */ (e.credentials));
    ...
    enablePersistence(t) {
        var e, n;
        if (this.Ad) throw new O(M.FAILED_PRECONDITION, "Firestore has already been started and persistence can no longer be enabled. You can only call enablePersistence() before calling any other methods on a Firestore object.");
        let s = !1, i = !1;
    ...
    async clearPersistence() {
        if (void 0 !== this.Ad && !this.Ad.ed) throw new O(M.FAILED_PRECONDITION, "Persistence can only be cleared before a Firestore instance is initialized or after it is terminated.");
        const t = new Xn;
    ...
    onSnapshotsInSync(t) {
        if (this.md(), No(t)) return Oo(this.Ad, t);
        {
            ki("Firestore.onSnapshotsInSync", "function", 1, t);
            const e = {
                next: t
            };
            return Oo(this.Ad, e);
    ...
    Cd() {
        return new C(this.Va, this.Pd, this.yd.host, this.yd.ssl, this.yd.forceLongPolling);
    }
    Sd(t, e) {
        const n = this.Cd();
        return this.Ad = new Co(this.Vd, this.Id), this.Ad.start(n, t, e);
    }
    static Rd(t) {
 ...
 */        const s = t.options.projectId;
    ...
    get app() {
        if (!this.Ed) throw new O(M.FAILED_PRECONDITION, "Firestore was not initialized using the Firebase SDK. 'app' is not available");
        return this.Ed;
    }
    collection(t) {
        return Fi("Firestore.collection", arguments, 1), ki("Firestore.collection", "non-empty string", 1, t), 
        this.md(), new Yo(U.$(t), this, 
        /* converter= */ null);
    }
    doc(t) {
        return Fi("Firestore.doc", arguments, 1), ki("Firestore.doc", "non-empty string", 1, t), 
        this.md(), qo.Fd(U.$(t), this, 
        /* converter= */ null);
    }
    collectionGroup(t) {
        if (Fi("Firestore.collectionGroup", arguments, 1), ki("Firestore.collectionGroup", "non-empty string", 1, t), 
        ...
        return this.md(), new Go(new Vn(U.k(), t), this, 
        /* converter= */ null);
    }
    runTransaction(t) {
        return Fi("Firestore.runTransaction", arguments, 1), ki("Firestore.runTransaction", "function", 1, t), 
        this.md().transaction(e => t(new Lo(this, e)));
    }
    batch() {
        return this.md(), new Bo(this);
    }
    static get logLevel() {
        switch (m()) {
          case n.DEBUG:
    ...
    static setLogLevel(t) {
        var e;
        Fi("Firestore.setLogLevel", arguments, 1), qi("setLogLevel", [ "debug", "error", "silent", "warn", "info", "verbose" ], 1, t), 
        e = t, I.setLogLevel(e);
    }
...
/** Registers the listener for onSnapshotsInSync() */ function Oo(t, e) {
    const n = new Fo({
        next: () => {
            e.next && e.next();
        },
 ...
 */ class Lo {
    ...
    get(t) {
        ...
        const e = th("Transaction.get", t, this.$d);
        return this.kd.ku([ e.ga ]).then(t => {
            if (!t || 1 !== t.length) return V();
            const n = t[0];
            if (n instanceof Rn) return new Wo(this.$d, e.ga, null, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.ya);
            if (n instanceof An) return new Wo(this.$d, e.ga, n, 
            /* fromCache= */ !1, 
            /* hasPendingWrites= */ !1, e.ya);
            throw V();
        });
    ...
    set(t, e, n) {
        $i("Transaction.set", arguments, 2, 3);
        const s = th("Transaction.set", t, this.$d);
        n = Jo("Transaction.set", n);
        const i = nh(s.ya, e, n), r = Ar(this.$d.pd, "Transaction.set", s.ga, i, null !== s.ya, n);
        return this.kd.set(s.ga, r), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return "string" == typeof e || e instanceof tr ? (Ni("Transaction.update", arguments, 3), 
        i = th("Transaction.update", t, this.$d), r = Pr(this.$d.pd, "Transaction.update", i.ga, e, n, s)) : (Fi("Transaction.update", arguments, 2), 
        i = th("Transaction.update", t, this.$d), r = Rr(this.$d.pd, "Transaction.update", i.ga, e)), 
        this.kd.update(i.ga, r), this;
    }
    delete(t) {
        Fi("Transaction.delete", arguments, 1);
        const e = th("Transaction.delete", t, this.$d);
...
class Bo {
    ...
    set(t, e, n) {
        $i("WriteBatch.set", arguments, 2, 3), this.Od();
        const s = th("WriteBatch.set", t, this.$d);
        n = Jo("WriteBatch.set", n);
        const i = nh(s.ya, e, n), r = Ar(this.$d.pd, "WriteBatch.set", s.ga, i, null !== s.ya, n);
        return this.xd = this.xd.concat(r.pa(s.ga, Ze.Qe())), this;
    }
    update(t, e, n, ...s) {
        let i, r;
        return this.Od(), "string" == typeof e || e instanceof tr ? (Ni("WriteBatch.update", arguments, 3), 
        i = th("WriteBatch.update", t, this.$d), r = Pr(this.$d.pd, "WriteBatch.update", i.ga, e, n, s)) : (Fi("WriteBatch.update", arguments, 2), 
        i = th("WriteBatch.update", t, this.$d), r = Rr(this.$d.pd, "WriteBatch.update", i.ga, e)), 
        this.xd = this.xd.concat(r.pa(i.ga, Ze.exists(!0))), this;
    }
    delete(t) {
        Fi("WriteBatch.delete", arguments, 1), this.Od();
        const e = th("WriteBatch.delete", t, this.$d);
        return this.xd = this.xd.concat(new dn(e.ga, Ze.Qe())), this;
    }
    commit() {
        return this.Od(), this.Md = !0, this.xd.length > 0 ? this.$d.md().write(this.xd) : Promise.resolve();
    }
    Od() {
        if (this.Md) throw new O(M.FAILED_PRECONDITION, "A write batch can no longer be used after commit() has been called.");
    }
}
 ...
 */ class qo extends dr {
    ...
    static Fd(t, e, n) {
        ...
        return new qo(new j(t), e, n);
    }
    get id() {
        return this.ga.path.S();
    }
    get parent() {
        return new Yo(this.ga.path.p(), this.firestore, this.ya);
    }
    get path() {
        return this.ga.path.N();
    }
    collection(t) {
        if (Fi("DocumentReference.collection", arguments, 1), ki("DocumentReference.collection", "non-empty string", 1, t), 
        !t) throw new O(M.INVALID_ARGUMENT, "Must provide a non-empty collection name to collection()");
        const e = U.$(t);
        return new Yo(this.ga.path.child(e), this.firestore, 
        /* converter= */ null);
    }
    isEqual(t) {
        if (!(t instanceof qo)) throw Gi("isEqual", "DocumentReference", 1, t);
        return this.firestore === t.firestore && this.ga.isEqual(t.ga) && this.ya === t.ya;
    }
    set(t, e) {
        $i("DocumentReference.set", arguments, 1, 2), e = Jo("DocumentReference.set", e);
        const n = nh(this.ya, t, e), s = Ar(this.firestore.pd, "DocumentReference.set", this.ga, n, null !== this.ya, e);
        return this.Ad.write(s.pa(this.ga, Ze.Qe()));
    }
    update(t, e, ...n) {
        let s;
        return "string" == typeof t || t instanceof tr ? (Ni("DocumentReference.update", arguments, 2), 
        s = Pr(this.firestore.pd, "DocumentReference.update", this.ga, t, e, n)) : (Fi("DocumentReference.update", arguments, 1), 
        s = Rr(this.firestore.pd, "DocumentReference.update", this.ga, t)), this.Ad.write(s.pa(this.ga, Ze.exists(!0)));
    }
    delete() {
        return Fi("DocumentReference.delete", arguments, 0), this.Ad.write([ new dn(this.ga, Ze.Qe()) ]);
    }
    onSnapshot(...t) {
        var e, n, s;
        $i("DocumentReference.onSnapshot", arguments, 1, 4);
        let i = {
            includeMetadataChanges: !1
        }, r = 0;
        "object" != typeof t[r] || No(t[r]) || (i = t[r], Ki("DocumentReference.onSnapshot", i, [ "includeMetadataChanges" ]), 
        Oi("DocumentReference.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++);
        const o = {
        ...
        } else ki("DocumentReference.onSnapshot", "function", r, t[r]), xi("DocumentReference.onSnapshot", "function", r + 1, t[r + 1]), 
        xi("DocumentReference.onSnapshot", "function", r + 2, t[r + 2]);
        const h = {
            next: e => {
                t[r] && t[r](this.Ld(e));
            },
        ...
        return Uo(this.Ad, this.ga, o, h);
    }
    get(t) {
        return $i("DocumentReference.get", arguments, 0, 1), Zo("DocumentReference.get", t), 
        t && "cache" === t.source ? this.firestore.md().nd(this.ga).then(t => new Wo(this.firestore, this.ga, t, 
        /*fromCache=*/ !0, t instanceof An && t.Ge, this.ya)) : 
        /**
 * Retrieves a latency-compensated document from the backend via a
 * SnapshotListener.
 */
        function(t, e, n) {
            const s = new Xn, i = Uo(t, e, {
    ...
    withConverter(t) {
        return new qo(this.ga, this.firestore, t);
    }
    /**
     ...
     */    Ld(t) {
        ...
        return new Wo(this.firestore, this.ga, e, t.fromCache, t.hasPendingWrites, this.ya);
    }
}

/** Registers an internal snapshot listener for `ref`. */ function Uo(t, e, n, s) {
    let i = t => {
...
class Wo {
    ...
    data(t) {
        if ($i("DocumentSnapshot.data", arguments, 0, 1), t = Xo("DocumentSnapshot.data", t), 
        this.Bd) {
            // We only want to use the converter and create a new DocumentSnapshot
            // if a converter has been provided.
            if (this.ya) {
                const e = new jo(this.$d, this.ga, this.Bd, this.qd, this.Ud, 
                /* converter= */ null);
                return this.ya.fromFirestore(e, t);
            }
            return new $o(this.$d.Va, this.$d.Nd(), t.serverTimestamps || "none", t => new qo(t, this.$d, /* converter= */ null)).ud(this.Bd.tn());
        }
    }
    get(t, e) {
        if ($i("DocumentSnapshot.get", arguments, 1, 2), e = Xo("DocumentSnapshot.get", e), 
        this.Bd) {
            const n = this.Bd.data().field(vr("DocumentSnapshot.get", t, this.ga));
            if (null !== n) {
                return new $o(this.$d.Va, this.$d.Nd(), e.serverTimestamps || "none", t => new qo(t, this.$d, this.ya)).ud(n);
            }
        }
    }
    get id() {
    ...
    get ref() {
        return new qo(this.ga, this.$d, this.ya);
    }
    get exists() {
        return null !== this.Bd;
    }
    get metadata() {
        return new Qo(this.Ud, this.qd);
    }
    isEqual(t) {
        if (!(t instanceof Wo)) throw Gi("isEqual", "DocumentSnapshot", 1, t);
...
/** The query class that is shared between the full, lite and legacy SDK. */ function Ko(t) {
    if (t.mn() && 0 === t.en.length) throw new O(M.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
class Go extends class {
    ...
    Wd(t, e, n) {
        let s;
        if (t.O()) {
            if ("array-contains" /* ARRAY_CONTAINS */ === e || "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e) throw new O(M.INVALID_ARGUMENT, `Invalid Query. You can't perform '${e}' ` + "queries on FieldPath.documentId().");
            if ("in" /* IN */ === e) {
                this.jd(n, e);
                const t = [];
        ...
        s = Vr(this.pd, "Query.where", n, "in" /* IN */ === e);
        const i = Sn.create(t, e, s);
        return this.Gd(i), i;
    }
    zd(t, e) {
        if (null !== this.Qd.startAt) throw new O(M.INVALID_ARGUMENT, "Invalid query. You must not call Query.startAt() or Query.startAfter() before calling Query.orderBy().");
        if (null !== this.Qd.endAt) throw new O(M.INVALID_ARGUMENT, "Invalid query. You must not call Query.endAt() or Query.endBefore() before calling Query.orderBy().");
        const n = new Bn(t, e);
        return this.Hd(n), n;
    }
    /**
     ...
     * server timestamp.
     */    Yd(t, e, n) {
        if (!e) throw new O(M.NOT_FOUND, "Can't use a DocumentSnapshot that doesn't exist for " + `${t}().`);
        const s = [];
        ...
        // results.
                for (const t of this.Qd.orderBy) if (t.field.O()) s.push(Ht(this.Va, e.key)); else {
            const n = e.field(t.field);
            if (xt(n)) throw new O(M.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + t.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
            if (null === n) {
                const e = t.field.N();
                throw new O(M.INVALID_ARGUMENT, "Invalid query. You are trying to start or end a query using a " + `document for which the field '${e}' (used as the ` + "orderBy) does not exist.");
            }
            s.push(n);
        }
        return new xn(s, n);
     ...
     */    Jd(t, e, n) {
        ...
        const s = this.Qd.en;
        if (e.length > s.length) throw new O(M.INVALID_ARGUMENT, `Too many arguments provided to ${t}(). ` + "The number of arguments must be less than or equal to the number of Query.orderBy() clauses");
        const i = [];
        for (let n = 0; n < e.length; n++) {
            const r = e[n];
            if (s[n].field.O()) {
                if ("string" != typeof r) throw new O(M.INVALID_ARGUMENT, "Invalid query. Expected a string for document ID in " + `${t}(), but got a ${typeof r}`);
                if (!this.Qd.Vn() && -1 !== r.indexOf("/")) throw new O(M.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by FieldPath.documentId(), " + `the value passed to ${t}() must be a plain document ID, but ` + `'${r}' contains a slash.`);
                const e = this.Qd.path.child(U.$(r));
                if (!j.W(e)) throw new O(M.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by " + `FieldPath.documentId(), the value passed to ${t}() must result in a ` + `valid document path, but '${e}' is not because it contains an odd number ` + "of segments.");
                const n = new j(e);
                i.push(Ht(this.Va, n));
            } else {
                const e = Vr(this.pd, t, r);
                i.push(e);
            }
        }
        return new xn(i, n);
     ...
     */    Kd(t) {
        if ("string" == typeof t) {
            if ("" === t) throw new O(M.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid document ID, but it was an empty string.");
            if (!this.Qd.Vn() && -1 !== t.indexOf("/")) throw new O(M.INVALID_ARGUMENT, "Invalid query. When querying a collection by FieldPath.documentId(), you must provide a plain document ID, but " + `'${t}' contains a '/' character.`);
            const e = this.Qd.path.child(U.$(t));
            if (!j.W(e)) throw new O(M.INVALID_ARGUMENT, "Invalid query. When querying a collection group by FieldPath.documentId(), the value provided must result in a valid document path, " + `but '${e}' is not because it has an odd number of segments (${e.length}).`);
            return Ht(this.Va, new j(e));
        }
        if (t instanceof dr) return Ht(this.Va, t.ga);
        throw new O(M.INVALID_ARGUMENT, "Invalid query. When querying with FieldPath.documentId(), you must provide a valid string or a DocumentReference, but it was: " + `${Wi(t)}.`);
    }
    /**
    ...
    Gd(t) {
        if (t instanceof Sn) {
            ...
            if (t.An()) {
                const e = this.Qd.an();
                if (null !== e && !e.isEqual(t.field)) throw new O(M.INVALID_ARGUMENT, "Invalid query. All where filters with an inequality (<, <=, >, or >=) must be on the same field. But you have" + ` inequality filters on '${e.toString()}'` + ` and '${t.field.toString()}'`);
                const n = this.Qd.un();
                ...
                throw r === t.op ? new O(M.INVALID_ARGUMENT, "Invalid query. You cannot use more than one " + `'${t.op.toString()}' filter.`) : new O(M.INVALID_ARGUMENT, `Invalid query. You cannot use '${t.op.toString()}' filters ` + `with '${r.toString()}' filters.`);
            }
        }
    }
    Hd(t) {
    ...
    Xd(t, e) {
        if (!e.isEqual(t)) throw new O(M.INVALID_ARGUMENT, "Invalid query. You have a where filter with an inequality " + `(<, <=, >, or >=) on field '${t.toString()}' ` + `and so you must also use '${t.toString()}' ` + "as your first Query.orderBy(), but your first Query.orderBy() " + `is on field '${e.toString()}' instead.`);
    }
} {
    constructor(t, e, n) {
    ...
    where(t, e, n) {
        Fi("Query.where", arguments, 3), ji("Query.where", 3, n);
        // Enumerated from the WhereFilterOp type in index.d.ts.
        const s = qi("Query.where", [ "<" /* LESS_THAN */ , "<=" /* LESS_THAN_OR_EQUAL */ , "==" /* EQUAL */ , ">=" /* GREATER_THAN_OR_EQUAL */ , ">" /* GREATER_THAN */ , "array-contains" /* ARRAY_CONTAINS */ , "in" /* IN */ , "array-contains-any" /* ARRAY_CONTAINS_ANY */ ], 2, e), i = vr("Query.where", t), r = this.Wd(i, s, n);
        return new Go(this.Qd.cn(r), this.firestore, this.ya);
    }
    orderBy(t, e) {
        let n;
        if ($i("Query.orderBy", arguments, 1, 2), xi("Query.orderBy", "non-empty string", 2, e), 
        ...
        const s = vr("Query.orderBy", t), i = this.zd(s, n);
        return new Go(this.Qd.ln(i), this.firestore, this.ya);
    }
    limit(t) {
        return Fi("Query.limit", arguments, 1), ki("Query.limit", "number", 1, t), zi("Query.limit", 1, t), 
        new Go(this.Qd._n(t), this.firestore, this.ya);
    }
    limitToLast(t) {
        return Fi("Query.limitToLast", arguments, 1), ki("Query.limitToLast", "number", 1, t), 
        zi("Query.limitToLast", 1, t), new Go(this.Qd.fn(t), this.firestore, this.ya);
    }
    startAt(t, ...e) {
        Ni("Query.startAt", arguments, 1);
        const n = this.Zd("Query.startAt", t, e, 
        /*before=*/ !0);
        return new Go(this.Qd.dn(n), this.firestore, this.ya);
    }
    startAfter(t, ...e) {
    ...
    endBefore(t, ...e) {
        ...
        /*before=*/ !0);
        return new Go(this.Qd.wn(n), this.firestore, this.ya);
    }
    endAt(t, ...e) {
    ...
    isEqual(t) {
        if (!(t instanceof Go)) throw Gi("isEqual", "Query", 1, t);
        return this.firestore === t.firestore && gn(this.Qd, t.Qd) && this.ya === t.ya;
    }
    withConverter(t) {
        return new Go(this.Qd, this.firestore, t);
    }
    /** Helper function to create a bound from a document or fields */    Zd(t, e, n, s) {
        if (ji(t, 1, e), e instanceof Wo) return Fi(t, [ e, ...n ], 1), this.Yd(t, e.Bd, s);
        {
            const i = [ e ].concat(n);
    ...
    onSnapshot(...t) {
        var e, n, s;
        $i("Query.onSnapshot", arguments, 1, 4);
        let i = {}, r = 0;
        if ("object" != typeof t[r] || No(t[r]) || (i = t[r], Ki("Query.onSnapshot", i, [ "includeMetadataChanges" ]), 
        Oi("Query.onSnapshot", "boolean", "includeMetadataChanges", i.includeMetadataChanges), 
        r++), No(t[r])) {
            const i = t[r];
            t[r] = null === (e = i.next) || void 0 === e ? void 0 : e.bind(i), t[r + 1] = null === (n = i.error) || void 0 === n ? void 0 : n.bind(i), 
            t[r + 2] = null === (s = i.complete) || void 0 === s ? void 0 : s.bind(i);
        } else ki("Query.onSnapshot", "function", r, t[r]), xi("Query.onSnapshot", "function", r + 1, t[r + 1]), 
        xi("Query.onSnapshot", "function", r + 2, t[r + 2]);
        const o = {
            next: e => {
                t[r] && t[r](new Ho(this.firestore, this.Qd, e, this.ya));
            },
            error: t[r + 1],
            complete: t[r + 2]
        };
        return Ko(this.Qd), zo(this.firestore.md(), this.Qd, i, o);
    }
    get(t) {
        $i("Query.get", arguments, 0, 1), Zo("Query.get", t), Ko(this.Qd);
        ...
        function(t, e, n) {
            const s = new Xn, i = zo(t, e, {
                ...
                next: t => {
                    // Remove query first before passing event to user to avoid
                    // user actions affecting the now stale query.
                    i(), t.fromCache && n && "server" === n.source ? s.reject(new O(M.UNAVAILABLE, 'Failed to get documents from server. (However, these documents may exist in the local cache. Run again without setting source to "server" to retrieve the cached documents.)')) : s.resolve(t);
                },
                error: t => s.reject(t)
            });
            return s.promise;
        }
        /** Registers an internal snapshot listener for `query`. */ (e, this.Qd, t)).then(t => new Ho(this.firestore, this.Qd, t, this.ya));
    }
}
...
class Ho {
    constructor(t, e, n, s) {
        ...
        this.metadata = new Qo(n.hasPendingWrites, n.fromCache);
    }
    get docs() {
        const t = [];
    ...
    forEach(t, e) {
        $i("QuerySnapshot.forEach", arguments, 1, 2), ki("QuerySnapshot.forEach", "function", 1, t), 
        this.ew.docs.forEach(n => {
            t.call(e, this.iw(n, this.metadata.fromCache, this.ew.Lt.has(n.key)));
        });
    }
    get query() {
        return new Go(this.tw, this.$d, this.ya);
    }
    docChanges(t) {
        t && (Ki("QuerySnapshot.docChanges", t, [ "includeMetadataChanges" ]), Oi("QuerySnapshot.docChanges", "boolean", "includeMetadataChanges", t.includeMetadataChanges));
        const e = !(!t || !t.includeMetadataChanges);
        if (e && this.ew.qt) throw new O(M.INVALID_ARGUMENT, "To include metadata changes with your document changes, you must also pass { includeMetadataChanges:true } to onSnapshot().");
 ...
 */
    ...
    /** Check the equality. The call can be very expensive. */    isEqual(t) {
        if (!(t instanceof Ho)) throw Gi("isEqual", "QuerySnapshot", 1, t);
        return this.$d === t.$d && gn(this.tw, t.tw) && this.ew.isEqual(t.ew) && this.ya === t.ya;
    }
    iw(t, e, n) {
        return new jo(this.$d, t.key, t, e, n, this.ya);
    }
}

class Yo extends Go {
    constructor(t, e, n) {
        if (super(Vn.hn(t), e, n), this.rw = t, t.length % 2 != 1) throw new O(M.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + `${t.N()} has ${t.length}`);
    }
    get id() {
    ...
    get parent() {
        ...
        return t._() ? null : new qo(new j(t), this.firestore, 
        /* converter= */ null);
    }
    get path() {
    ...
    doc(t) {
        $i("CollectionReference.doc", arguments, 0, 1), 
        // We allow omission of 'pathString' but explicitly prohibit passing in both
        // 'undefined' and 'null'.
        0 === arguments.length && (t = b.t()), ki("CollectionReference.doc", "non-empty string", 1, t);
        const e = U.$(t);
        return qo.Fd(this.Qd.path.child(e), this.firestore, this.ya);
    }
    add(t) {
        Fi("CollectionReference.add", arguments, 1), ki("CollectionReference.add", "object", 1, this.ya ? this.ya.toFirestore(t) : t);
        const e = this.doc();
        return e.set(t).then(() => e);
    }
    withConverter(t) {
        return new Yo(this.rw, this.firestore, t);
    }
}
...
function Jo(t, e) {
    ...
    if (Ki(t, e, [ "merge", "mergeFields" ]), Oi(t, "boolean", "merge", e.merge), Li(t, "mergeFields", "a string or a FieldPath", e.mergeFields, t => "string" == typeof t || t instanceof tr), 
...
function Xo(t, e) {
    return void 0 === e ? {} : (Ki(t, e, [ "serverTimestamps" ]), Bi(t, 0, "serverTimestamps", e.serverTimestamps, [ "estimate", "previous", "none" ]), 
    e);
}

function Zo(t, e) {
    xi(t, "object", 1, e), e && (Ki(t, e, [ "source" ]), Bi(t, 0, "source", e.source, [ "default", "server", "cache" ]));
}
...
function th(t, e, n) {
    ...
    throw Gi(t, "DocumentReference", 1, e);
}
...
const sh = {
    ...
    QuerySnapshot: Ho,
    CollectionReference: Yo,
    FieldPath: tr,
    FieldValue: ur,
    setLogLevel: Mo.setLogLevel,
    CACHE_SIZE_UNLIMITED: ko
};
...
function ih(t) {
    ...
    }(t, (t, e) => new Mo(t, e, new Do)), t.registerVersion("@firebase/firestore", "1.16.1", "rn");
}

ih(t);

export { ih as __PRIVATE_registerFirestore };
