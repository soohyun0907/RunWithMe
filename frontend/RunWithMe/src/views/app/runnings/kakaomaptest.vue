<template>
  <div class="main-content">
    <breadcumb :page="'KakaoTest'" :folder="'Runnings'" />
...
function getTimeHTML(distance) {
    ...
    startLocationUpdates() {
      ...
      var marker = new kakao.maps.Marker({
        ...
        this.watchId = navigator.geolocation.watchPosition(
          (position) => {
            ...
            map.setCenter(new kakao.maps.LatLng(this.lat, this.lng));
            marker.setPosition(new kakao.maps.LatLng(this.lat, this.lng));
          },
          (error) => {
      ...
      console.log("navigator 외부" + this.lat);
    },
    stopLocationUpdates() {
